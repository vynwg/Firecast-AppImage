/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d2d1_3.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID2D1SpriteBatch_QueryInterface(ID2D1SpriteBatch* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID2D1SpriteBatch_AddRef(ID2D1SpriteBatch* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID2D1SpriteBatch_Release(ID2D1SpriteBatch* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static __WIDL_INLINE void ID2D1SpriteBatch_GetFactory(ID2D1SpriteBatch* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1SpriteBatch methods ***/
static __WIDL_INLINE HRESULT ID2D1SpriteBatch_AddSprites(ID2D1SpriteBatch* This,UINT32 sprite_count,const D2D1_RECT_F *destination_rectangles,const D2D1_RECT_U *source_rectangles,const D2D1_COLOR_F *colors,const D2D1_MATRIX_3X2_F *transforms,UINT32 destination_rectangles_stride,UINT32 source_rectangles_stride,UINT32 colors_stride,UINT32 transforms_stride) {
...
static __WIDL_INLINE HRESULT ID2D1SpriteBatch_SetSprites(ID2D1SpriteBatch* This,UINT32 start_index,UINT32 sprite_count,const D2D1_RECT_F *destination_rectangles,const D2D1_RECT_U *source_rectangles,const D2D1_COLOR_F *colors,const D2D1_MATRIX_3X2_F *transforms,UINT32 destination_rectangles_stride,UINT32 source_rectangles_stride,UINT32 colors_stride,UINT32 transforms_stride) {
...
static __WIDL_INLINE HRESULT ID2D1SpriteBatch_GetSprites(ID2D1SpriteBatch* This,UINT32 start_index,UINT32 sprite_count,D2D1_RECT_F *destination_rectangles,D2D1_RECT_U *source_rectangles,D2D1_COLOR_F *colors,D2D1_MATRIX_3X2_F *transforms) {
    return This->lpVtbl->GetSprites(This,start_index,sprite_count,destination_rectangles,source_rectangles,colors,transforms);
}
static __WIDL_INLINE UINT32 ID2D1SpriteBatch_GetSpriteCount(ID2D1SpriteBatch* This) {
    return This->lpVtbl->GetSpriteCount(This);
}
static __WIDL_INLINE void ID2D1SpriteBatch_Clear(ID2D1SpriteBatch* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID2D1SvgGlyphStyle_QueryInterface(ID2D1SvgGlyphStyle* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID2D1SvgGlyphStyle_AddRef(ID2D1SvgGlyphStyle* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID2D1SvgGlyphStyle_Release(ID2D1SvgGlyphStyle* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static __WIDL_INLINE void ID2D1SvgGlyphStyle_GetFactory(ID2D1SvgGlyphStyle* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1SvgGlyphStyle methods ***/
static __WIDL_INLINE HRESULT ID2D1SvgGlyphStyle_SetFill(ID2D1SvgGlyphStyle* This,ID2D1Brush *brush) {
    return This->lpVtbl->SetFill(This,brush);
}
static __WIDL_INLINE void ID2D1SvgGlyphStyle_GetFill(ID2D1SvgGlyphStyle* This,ID2D1Brush **brush) {
    This->lpVtbl->GetFill(This,brush);
}
static __WIDL_INLINE HRESULT ID2D1SvgGlyphStyle_SetStroke(ID2D1SvgGlyphStyle* This,ID2D1Brush *brush,FLOAT stroke_width,const FLOAT *dashes,UINT32 dashes_count,FLOAT dash_offset) {
    return This->lpVtbl->SetStroke(This,brush,stroke_width,dashes,dashes_count,dash_offset);
}
static __WIDL_INLINE UINT32 ID2D1SvgGlyphStyle_GetStrokeDashesCount(ID2D1SvgGlyphStyle* This) {
    return This->lpVtbl->GetStrokeDashesCount(This);
}
static __WIDL_INLINE void ID2D1SvgGlyphStyle_GetStroke(ID2D1SvgGlyphStyle* This,ID2D1Brush **brush,FLOAT *stroke_width,FLOAT *dashes,UINT32 dashes_count,FLOAT *dash_offset) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_QueryInterface(ID2D1DeviceContext3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID2D1DeviceContext3_AddRef(ID2D1DeviceContext3* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID2D1DeviceContext3_Release(ID2D1DeviceContext3* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static __WIDL_INLINE void ID2D1DeviceContext3_GetFactory(ID2D1DeviceContext3* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1RenderTarget methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateSharedBitmap(ID2D1DeviceContext3* This,REFIID iid,void *data,const D2D1_BITMAP_PROPERTIES *desc,ID2D1Bitmap **bitmap) {
    return This->lpVtbl->CreateSharedBitmap(This,iid,data,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateSolidColorBrush(ID2D1DeviceContext3* This,const D2D1_COLOR_F *color,const D2D1_BRUSH_PROPERTIES *desc,ID2D1SolidColorBrush **brush) {
    return This->lpVtbl->CreateSolidColorBrush(This,color,desc,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateLinearGradientBrush(ID2D1DeviceContext3* This,const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1LinearGradientBrush **brush) {
    return This->lpVtbl->CreateLinearGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateRadialGradientBrush(ID2D1DeviceContext3* This,const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1RadialGradientBrush **brush) {
    return This->lpVtbl->CreateRadialGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateCompatibleRenderTarget(ID2D1DeviceContext3* This,const D2D1_SIZE_F *size,const D2D1_SIZE_U *pixel_size,const D2D1_PIXEL_FORMAT *format,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options,ID2D1BitmapRenderTarget **render_target) {
    return This->lpVtbl->CreateCompatibleRenderTarget(This,size,pixel_size,format,options,render_target);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateLayer(ID2D1DeviceContext3* This,const D2D1_SIZE_F *size,ID2D1Layer **layer) {
    return This->lpVtbl->CreateLayer(This,size,layer);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateMesh(ID2D1DeviceContext3* This,ID2D1Mesh **mesh) {
    return This->lpVtbl->CreateMesh(This,mesh);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawLine(ID2D1DeviceContext3* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawRectangle(ID2D1DeviceContext3* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillRectangle(ID2D1DeviceContext3* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRectangle(This,rect,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawRoundedRectangle(ID2D1DeviceContext3* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRoundedRectangle(This,rect,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillRoundedRectangle(ID2D1DeviceContext3* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRoundedRectangle(This,rect,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawEllipse(ID2D1DeviceContext3* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawEllipse(This,ellipse,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillEllipse(ID2D1DeviceContext3* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush) {
    This->lpVtbl->FillEllipse(This,ellipse,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawGeometry(ID2D1DeviceContext3* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillGeometry(ID2D1DeviceContext3* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillMesh(ID2D1DeviceContext3* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    This->lpVtbl->FillMesh(This,mesh,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawText(ID2D1DeviceContext3* This,const WCHAR *string,UINT32 string_len,IDWriteTextFormat *text_format,const D2D1_RECT_F *layout_rect,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->DrawText(This,string,string_len,text_format,layout_rect,brush,options,measuring_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawTextLayout(ID2D1DeviceContext3* This,D2D1_POINT_2F origin,IDWriteTextLayout *layout,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options) {
    This->lpVtbl->DrawTextLayout(This,origin,layout,brush,options);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetTransform(ID2D1DeviceContext3* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetTransform(ID2D1DeviceContext3* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetAntialiasMode(ID2D1DeviceContext3* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE D2D1_ANTIALIAS_MODE ID2D1DeviceContext3_GetAntialiasMode(ID2D1DeviceContext3* This) {
    return This->lpVtbl->GetAntialiasMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetTextAntialiasMode(ID2D1DeviceContext3* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE D2D1_TEXT_ANTIALIAS_MODE ID2D1DeviceContext3_GetTextAntialiasMode(ID2D1DeviceContext3* This) {
    return This->lpVtbl->GetTextAntialiasMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetTextRenderingParams(ID2D1DeviceContext3* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetTextRenderingParams(ID2D1DeviceContext3* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetTags(ID2D1DeviceContext3* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    This->lpVtbl->SetTags(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetTags(ID2D1DeviceContext3* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    This->lpVtbl->GetTags(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext3_PopLayer(ID2D1DeviceContext3* This) {
    This->lpVtbl->PopLayer(This);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_Flush(ID2D1DeviceContext3* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->Flush(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SaveDrawingState(ID2D1DeviceContext3* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->SaveDrawingState(This,state_block);
}
static __WIDL_INLINE void ID2D1DeviceContext3_RestoreDrawingState(ID2D1DeviceContext3* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->RestoreDrawingState(This,state_block);
}
static __WIDL_INLINE void ID2D1DeviceContext3_PushAxisAlignedClip(ID2D1DeviceContext3* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext3_PopAxisAlignedClip(ID2D1DeviceContext3* This) {
    This->lpVtbl->PopAxisAlignedClip(This);
}
static __WIDL_INLINE void ID2D1DeviceContext3_Clear(ID2D1DeviceContext3* This,const D2D1_COLOR_F *color) {
    This->lpVtbl->Clear(This,color);
}
static __WIDL_INLINE void ID2D1DeviceContext3_BeginDraw(ID2D1DeviceContext3* This) {
    This->lpVtbl->BeginDraw(This);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_EndDraw(ID2D1DeviceContext3* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->EndDraw(This,tag1,tag2);
}
static __WIDL_INLINE D2D1_PIXEL_FORMAT ID2D1DeviceContext3_GetPixelFormat(ID2D1DeviceContext3* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetDpi(ID2D1DeviceContext3* This,float dpi_x,float dpi_y) {
    This->lpVtbl->SetDpi(This,dpi_x,dpi_y);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetDpi(ID2D1DeviceContext3* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static __WIDL_INLINE D2D1_SIZE_F ID2D1DeviceContext3_GetSize(ID2D1DeviceContext3* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static __WIDL_INLINE D2D1_SIZE_U ID2D1DeviceContext3_GetPixelSize(ID2D1DeviceContext3* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static __WIDL_INLINE UINT32 ID2D1DeviceContext3_GetMaximumBitmapSize(ID2D1DeviceContext3* This) {
    return This->lpVtbl->GetMaximumBitmapSize(This);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext3_IsSupported(ID2D1DeviceContext3* This,const D2D1_RENDER_TARGET_PROPERTIES *desc) {
    return This->lpVtbl->IsSupported(This,desc);
}
/*** ID2D1DeviceContext methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateBitmap(ID2D1DeviceContext3* This,D2D1_SIZE_U size,const void *src_data,UINT32 pitch,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmap(This,size,src_data,pitch,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateBitmapFromWicBitmap(ID2D1DeviceContext3* This,IWICBitmapSource *bitmap_source,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(This,bitmap_source,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateColorContext(ID2D1DeviceContext3* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateColorContextFromFilename(ID2D1DeviceContext3* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateColorContextFromWicColorContext(ID2D1DeviceContext3* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateBitmapFromDxgiSurface(ID2D1DeviceContext3* This,IDXGISurface *surface,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->CreateBitmapFromDxgiSurface(This,surface,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateEffect(ID2D1DeviceContext3* This,REFCLSID effect_id,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,effect_id,effect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateGradientStopCollection(ID2D1DeviceContext3* This,const D2D1_GRADIENT_STOP *stops,UINT32 stop_count,D2D1_COLOR_SPACE preinterpolation_space,D2D1_COLOR_SPACE postinterpolation_space,D2D1_BUFFER_PRECISION buffer_precision,D2D1_EXTEND_MODE extend_mode,D2D1_COLOR_INTERPOLATION_MODE color_interpolation_mode,ID2D1GradientStopCollection1 **gradient) {
    return This->lpVtbl->ID2D1DeviceContext_CreateGradientStopCollection(This,stops,stop_count,preinterpolation_space,postinterpolation_space,buffer_precision,extend_mode,color_interpolation_mode,gradient);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateImageBrush(ID2D1DeviceContext3* This,ID2D1Image *image,const D2D1_IMAGE_BRUSH_PROPERTIES *image_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1ImageBrush **brush) {
    return This->lpVtbl->CreateImageBrush(This,image,image_brush_desc,brush_desc,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateBitmapBrush(ID2D1DeviceContext3* This,ID2D1Bitmap *bitmap,const D2D1_BITMAP_BRUSH_PROPERTIES1 *bitmap_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1BitmapBrush1 **bitmap_brush) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(This,bitmap,bitmap_brush_desc,brush_desc,bitmap_brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateCommandList(ID2D1DeviceContext3* This,ID2D1CommandList **command_list) {
    return This->lpVtbl->CreateCommandList(This,command_list);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext3_IsDxgiFormatSupported(ID2D1DeviceContext3* This,DXGI_FORMAT format) {
    return This->lpVtbl->IsDxgiFormatSupported(This,format);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext3_IsBufferPrecisionSupported(ID2D1DeviceContext3* This,D2D1_BUFFER_PRECISION buffer_precision) {
    return This->lpVtbl->IsBufferPrecisionSupported(This,buffer_precision);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetImageLocalBounds(ID2D1DeviceContext3* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
    This->lpVtbl->GetImageLocalBounds(This,image,local_bounds);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetImageWorldBounds(ID2D1DeviceContext3* This,ID2D1Image *image,D2D1_RECT_F *world_bounds) {
    return This->lpVtbl->GetImageWorldBounds(This,image,world_bounds);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetGlyphRunWorldBounds(ID2D1DeviceContext3* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGlyphRunWorldBounds(This,baseline_origin,glyph_run,measuring_mode,bounds);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetDevice(ID2D1DeviceContext3* This,ID2D1Device **device) {
    This->lpVtbl->GetDevice(This,device);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetTarget(ID2D1DeviceContext3* This,ID2D1Image *target) {
    This->lpVtbl->SetTarget(This,target);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetTarget(ID2D1DeviceContext3* This,ID2D1Image **target) {
    This->lpVtbl->GetTarget(This,target);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetRenderingControls(ID2D1DeviceContext3* This,const D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->SetRenderingControls(This,rendering_controls);
}
static __WIDL_INLINE void ID2D1DeviceContext3_GetRenderingControls(ID2D1DeviceContext3* This,D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->GetRenderingControls(This,rendering_controls);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetPrimitiveBlend(ID2D1DeviceContext3* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static __WIDL_INLINE D2D1_PRIMITIVE_BLEND ID2D1DeviceContext3_GetPrimitiveBlend(ID2D1DeviceContext3* This) {
    return This->lpVtbl->GetPrimitiveBlend(This);
}
static __WIDL_INLINE void ID2D1DeviceContext3_SetUnitMode(ID2D1DeviceContext3* This,D2D1_UNIT_MODE unit_mode) {
    This->lpVtbl->SetUnitMode(This,unit_mode);
}
static __WIDL_INLINE D2D1_UNIT_MODE ID2D1DeviceContext3_GetUnitMode(ID2D1DeviceContext3* This) {
    return This->lpVtbl->GetUnitMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawGlyphRun(ID2D1DeviceContext3* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawImage(ID2D1DeviceContext3* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawBitmap(ID2D1DeviceContext3* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    This->lpVtbl->ID2D1DeviceContext_DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static __WIDL_INLINE void ID2D1DeviceContext3_PushLayer(ID2D1DeviceContext3* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    This->lpVtbl->ID2D1DeviceContext_PushLayer(This,layer_parameters,layer);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_InvalidateEffectInputRectangle(ID2D1DeviceContext3* This,ID2D1Effect *effect,UINT32 input,const D2D1_RECT_F *input_rect) {
    return This->lpVtbl->InvalidateEffectInputRectangle(This,effect,input,input_rect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetEffectInvalidRectangleCount(ID2D1DeviceContext3* This,ID2D1Effect *effect,UINT32 *rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangleCount(This,effect,rect_count);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetEffectInvalidRectangles(ID2D1DeviceContext3* This,ID2D1Effect *effect,D2D1_RECT_F *rectangles,UINT32 rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangles(This,effect,rectangles,rect_count);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetEffectRequiredInputRectangles(ID2D1DeviceContext3* This,ID2D1Effect *effect,const D2D1_RECT_F *image_rect,const D2D1_EFFECT_INPUT_DESCRIPTION *desc,D2D1_RECT_F *input_rect,UINT32 input_count) {
    return This->lpVtbl->GetEffectRequiredInputRectangles(This,effect,image_rect,desc,input_rect,input_count);
}
static __WIDL_INLINE void ID2D1DeviceContext3_FillOpacityMask(ID2D1DeviceContext3* This,ID2D1Bitmap *mask,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext_FillOpacityMask(This,mask,brush,dst_rect,src_rect);
}
/*** ID2D1DeviceContext1 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateFilledGeometryRealization(ID2D1DeviceContext3* This,ID2D1Geometry *geometry,float tolerance,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateFilledGeometryRealization(This,geometry,tolerance,realization);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateStrokedGeometryRealization(ID2D1DeviceContext3* This,ID2D1Geometry *geometry,float tolerance,float stroke_width,ID2D1StrokeStyle *stroke_style,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateStrokedGeometryRealization(This,geometry,tolerance,stroke_width,stroke_style,realization);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawGeometryRealization(ID2D1DeviceContext3* This,ID2D1GeometryRealization *realization,ID2D1Brush *brush) {
    This->lpVtbl->DrawGeometryRealization(This,realization,brush);
}
/*** ID2D1DeviceContext2 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateInk(ID2D1DeviceContext3* This,const D2D1_INK_POINT *start_point,ID2D1Ink **ink) {
    return This->lpVtbl->CreateInk(This,start_point,ink);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateInkStyle(ID2D1DeviceContext3* This,const D2D1_INK_STYLE_PROPERTIES *ink_style_properties,ID2D1InkStyle **ink_style) {
    return This->lpVtbl->CreateInkStyle(This,ink_style_properties,ink_style);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateGradientMesh(ID2D1DeviceContext3* This,const D2D1_GRADIENT_MESH_PATCH *patches,UINT32 patches_count,ID2D1GradientMesh **gradient_mesh) {
    return This->lpVtbl->CreateGradientMesh(This,patches,patches_count,gradient_mesh);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateImageSourceFromWic(ID2D1DeviceContext3* This,IWICBitmapSource *wic_bitmap_source,D2D1_IMAGE_SOURCE_LOADING_OPTIONS loading_options,D2D1_ALPHA_MODE alpha_mode,ID2D1ImageSourceFromWic **image_source) {
    return This->lpVtbl->CreateImageSourceFromWic(This,wic_bitmap_source,loading_options,alpha_mode,image_source);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateLookupTable3D(ID2D1DeviceContext3* This,D2D1_BUFFER_PRECISION precision,const UINT32 *extents,const BYTE *data,UINT32 data_count,const UINT32 *strides,ID2D1LookupTable3D **lookup_table) {
    return This->lpVtbl->CreateLookupTable3D(This,precision,extents,data,data_count,strides,lookup_table);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateImageSourceFromDxgi(ID2D1DeviceContext3* This,IDXGISurface **surfaces,UINT32 surface_count,DXGI_COLOR_SPACE_TYPE color_space,D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options,ID2D1ImageSource **image_source) {
    return This->lpVtbl->CreateImageSourceFromDxgi(This,surfaces,surface_count,color_space,options,image_source);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_GetGradientMeshWorldBounds(ID2D1DeviceContext3* This,ID2D1GradientMesh *gradient_mesh,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGradientMeshWorldBounds(This,gradient_mesh,bounds);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawInk(ID2D1DeviceContext3* This,ID2D1Ink *ink,ID2D1Brush *brush,ID2D1InkStyle *ink_style) {
    This->lpVtbl->DrawInk(This,ink,brush,ink_style);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawGradientMesh(ID2D1DeviceContext3* This,ID2D1GradientMesh *gradient_mesh) {
    This->lpVtbl->DrawGradientMesh(This,gradient_mesh);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawGdiMetafile(ID2D1DeviceContext3* This,ID2D1GdiMetafile *gdi_metafile,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext2_DrawGdiMetafile(This,gdi_metafile,dst_rect,src_rect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateTransformedImageSource(ID2D1DeviceContext3* This,ID2D1ImageSource *source,const D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES *props,ID2D1TransformedImageSource **transformed) {
    return This->lpVtbl->CreateTransformedImageSource(This,source,props,transformed);
}
/*** ID2D1DeviceContext3 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext3_CreateSpriteBatch(ID2D1DeviceContext3* This,ID2D1SpriteBatch **sprite_batch) {
    return This->lpVtbl->CreateSpriteBatch(This,sprite_batch);
}
static __WIDL_INLINE void ID2D1DeviceContext3_DrawSpriteBatch(ID2D1DeviceContext3* This,ID2D1SpriteBatch *sprite_batch,UINT32 start_index,UINT32 sprite_count,ID2D1Bitmap *bitmap,D2D1_BITMAP_INTERPOLATION_MODE interpolation_mode,D2D1_SPRITE_OPTIONS sprite_options) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_QueryInterface(ID2D1DeviceContext4* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID2D1DeviceContext4_AddRef(ID2D1DeviceContext4* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID2D1DeviceContext4_Release(ID2D1DeviceContext4* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static __WIDL_INLINE void ID2D1DeviceContext4_GetFactory(ID2D1DeviceContext4* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1RenderTarget methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateSharedBitmap(ID2D1DeviceContext4* This,REFIID iid,void *data,const D2D1_BITMAP_PROPERTIES *desc,ID2D1Bitmap **bitmap) {
    return This->lpVtbl->CreateSharedBitmap(This,iid,data,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateSolidColorBrush(ID2D1DeviceContext4* This,const D2D1_COLOR_F *color,const D2D1_BRUSH_PROPERTIES *desc,ID2D1SolidColorBrush **brush) {
    return This->lpVtbl->CreateSolidColorBrush(This,color,desc,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateLinearGradientBrush(ID2D1DeviceContext4* This,const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1LinearGradientBrush **brush) {
    return This->lpVtbl->CreateLinearGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateRadialGradientBrush(ID2D1DeviceContext4* This,const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1RadialGradientBrush **brush) {
    return This->lpVtbl->CreateRadialGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateCompatibleRenderTarget(ID2D1DeviceContext4* This,const D2D1_SIZE_F *size,const D2D1_SIZE_U *pixel_size,const D2D1_PIXEL_FORMAT *format,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options,ID2D1BitmapRenderTarget **render_target) {
    return This->lpVtbl->CreateCompatibleRenderTarget(This,size,pixel_size,format,options,render_target);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateLayer(ID2D1DeviceContext4* This,const D2D1_SIZE_F *size,ID2D1Layer **layer) {
    return This->lpVtbl->CreateLayer(This,size,layer);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateMesh(ID2D1DeviceContext4* This,ID2D1Mesh **mesh) {
    return This->lpVtbl->CreateMesh(This,mesh);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawLine(ID2D1DeviceContext4* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawRectangle(ID2D1DeviceContext4* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillRectangle(ID2D1DeviceContext4* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRectangle(This,rect,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawRoundedRectangle(ID2D1DeviceContext4* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRoundedRectangle(This,rect,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillRoundedRectangle(ID2D1DeviceContext4* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRoundedRectangle(This,rect,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawEllipse(ID2D1DeviceContext4* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawEllipse(This,ellipse,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillEllipse(ID2D1DeviceContext4* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush) {
    This->lpVtbl->FillEllipse(This,ellipse,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawGeometry(ID2D1DeviceContext4* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillGeometry(ID2D1DeviceContext4* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillMesh(ID2D1DeviceContext4* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    This->lpVtbl->FillMesh(This,mesh,brush);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetTransform(ID2D1DeviceContext4* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetTransform(ID2D1DeviceContext4* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetAntialiasMode(ID2D1DeviceContext4* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE D2D1_ANTIALIAS_MODE ID2D1DeviceContext4_GetAntialiasMode(ID2D1DeviceContext4* This) {
    return This->lpVtbl->GetAntialiasMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetTextAntialiasMode(ID2D1DeviceContext4* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE D2D1_TEXT_ANTIALIAS_MODE ID2D1DeviceContext4_GetTextAntialiasMode(ID2D1DeviceContext4* This) {
    return This->lpVtbl->GetTextAntialiasMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetTextRenderingParams(ID2D1DeviceContext4* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetTextRenderingParams(ID2D1DeviceContext4* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetTags(ID2D1DeviceContext4* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    This->lpVtbl->SetTags(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetTags(ID2D1DeviceContext4* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    This->lpVtbl->GetTags(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext4_PopLayer(ID2D1DeviceContext4* This) {
    This->lpVtbl->PopLayer(This);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_Flush(ID2D1DeviceContext4* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->Flush(This,tag1,tag2);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SaveDrawingState(ID2D1DeviceContext4* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->SaveDrawingState(This,state_block);
}
static __WIDL_INLINE void ID2D1DeviceContext4_RestoreDrawingState(ID2D1DeviceContext4* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->RestoreDrawingState(This,state_block);
}
static __WIDL_INLINE void ID2D1DeviceContext4_PushAxisAlignedClip(ID2D1DeviceContext4* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext4_PopAxisAlignedClip(ID2D1DeviceContext4* This) {
    This->lpVtbl->PopAxisAlignedClip(This);
}
static __WIDL_INLINE void ID2D1DeviceContext4_Clear(ID2D1DeviceContext4* This,const D2D1_COLOR_F *color) {
    This->lpVtbl->Clear(This,color);
}
static __WIDL_INLINE void ID2D1DeviceContext4_BeginDraw(ID2D1DeviceContext4* This) {
    This->lpVtbl->BeginDraw(This);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_EndDraw(ID2D1DeviceContext4* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->EndDraw(This,tag1,tag2);
}
static __WIDL_INLINE D2D1_PIXEL_FORMAT ID2D1DeviceContext4_GetPixelFormat(ID2D1DeviceContext4* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetDpi(ID2D1DeviceContext4* This,float dpi_x,float dpi_y) {
    This->lpVtbl->SetDpi(This,dpi_x,dpi_y);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetDpi(ID2D1DeviceContext4* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static __WIDL_INLINE D2D1_SIZE_F ID2D1DeviceContext4_GetSize(ID2D1DeviceContext4* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static __WIDL_INLINE D2D1_SIZE_U ID2D1DeviceContext4_GetPixelSize(ID2D1DeviceContext4* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static __WIDL_INLINE UINT32 ID2D1DeviceContext4_GetMaximumBitmapSize(ID2D1DeviceContext4* This) {
    return This->lpVtbl->GetMaximumBitmapSize(This);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext4_IsSupported(ID2D1DeviceContext4* This,const D2D1_RENDER_TARGET_PROPERTIES *desc) {
    return This->lpVtbl->IsSupported(This,desc);
}
/*** ID2D1DeviceContext methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateBitmap(ID2D1DeviceContext4* This,D2D1_SIZE_U size,const void *src_data,UINT32 pitch,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmap(This,size,src_data,pitch,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateBitmapFromWicBitmap(ID2D1DeviceContext4* This,IWICBitmapSource *bitmap_source,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(This,bitmap_source,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateColorContext(ID2D1DeviceContext4* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateColorContextFromFilename(ID2D1DeviceContext4* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateColorContextFromWicColorContext(ID2D1DeviceContext4* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateBitmapFromDxgiSurface(ID2D1DeviceContext4* This,IDXGISurface *surface,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->CreateBitmapFromDxgiSurface(This,surface,desc,bitmap);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateEffect(ID2D1DeviceContext4* This,REFCLSID effect_id,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,effect_id,effect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateGradientStopCollection(ID2D1DeviceContext4* This,const D2D1_GRADIENT_STOP *stops,UINT32 stop_count,D2D1_COLOR_SPACE preinterpolation_space,D2D1_COLOR_SPACE postinterpolation_space,D2D1_BUFFER_PRECISION buffer_precision,D2D1_EXTEND_MODE extend_mode,D2D1_COLOR_INTERPOLATION_MODE color_interpolation_mode,ID2D1GradientStopCollection1 **gradient) {
    return This->lpVtbl->ID2D1DeviceContext_CreateGradientStopCollection(This,stops,stop_count,preinterpolation_space,postinterpolation_space,buffer_precision,extend_mode,color_interpolation_mode,gradient);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateImageBrush(ID2D1DeviceContext4* This,ID2D1Image *image,const D2D1_IMAGE_BRUSH_PROPERTIES *image_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1ImageBrush **brush) {
    return This->lpVtbl->CreateImageBrush(This,image,image_brush_desc,brush_desc,brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateBitmapBrush(ID2D1DeviceContext4* This,ID2D1Bitmap *bitmap,const D2D1_BITMAP_BRUSH_PROPERTIES1 *bitmap_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1BitmapBrush1 **bitmap_brush) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(This,bitmap,bitmap_brush_desc,brush_desc,bitmap_brush);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateCommandList(ID2D1DeviceContext4* This,ID2D1CommandList **command_list) {
    return This->lpVtbl->CreateCommandList(This,command_list);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext4_IsDxgiFormatSupported(ID2D1DeviceContext4* This,DXGI_FORMAT format) {
    return This->lpVtbl->IsDxgiFormatSupported(This,format);
}
static __WIDL_INLINE BOOL ID2D1DeviceContext4_IsBufferPrecisionSupported(ID2D1DeviceContext4* This,D2D1_BUFFER_PRECISION buffer_precision) {
    return This->lpVtbl->IsBufferPrecisionSupported(This,buffer_precision);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetImageLocalBounds(ID2D1DeviceContext4* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
    This->lpVtbl->GetImageLocalBounds(This,image,local_bounds);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetImageWorldBounds(ID2D1DeviceContext4* This,ID2D1Image *image,D2D1_RECT_F *world_bounds) {
    return This->lpVtbl->GetImageWorldBounds(This,image,world_bounds);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetGlyphRunWorldBounds(ID2D1DeviceContext4* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGlyphRunWorldBounds(This,baseline_origin,glyph_run,measuring_mode,bounds);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetDevice(ID2D1DeviceContext4* This,ID2D1Device **device) {
    This->lpVtbl->GetDevice(This,device);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetTarget(ID2D1DeviceContext4* This,ID2D1Image *target) {
    This->lpVtbl->SetTarget(This,target);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetTarget(ID2D1DeviceContext4* This,ID2D1Image **target) {
    This->lpVtbl->GetTarget(This,target);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetRenderingControls(ID2D1DeviceContext4* This,const D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->SetRenderingControls(This,rendering_controls);
}
static __WIDL_INLINE void ID2D1DeviceContext4_GetRenderingControls(ID2D1DeviceContext4* This,D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->GetRenderingControls(This,rendering_controls);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetPrimitiveBlend(ID2D1DeviceContext4* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static __WIDL_INLINE D2D1_PRIMITIVE_BLEND ID2D1DeviceContext4_GetPrimitiveBlend(ID2D1DeviceContext4* This) {
    return This->lpVtbl->GetPrimitiveBlend(This);
}
static __WIDL_INLINE void ID2D1DeviceContext4_SetUnitMode(ID2D1DeviceContext4* This,D2D1_UNIT_MODE unit_mode) {
    This->lpVtbl->SetUnitMode(This,unit_mode);
}
static __WIDL_INLINE D2D1_UNIT_MODE ID2D1DeviceContext4_GetUnitMode(ID2D1DeviceContext4* This) {
    return This->lpVtbl->GetUnitMode(This);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawGlyphRun(ID2D1DeviceContext4* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawImage(ID2D1DeviceContext4* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawBitmap(ID2D1DeviceContext4* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    This->lpVtbl->ID2D1DeviceContext_DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static __WIDL_INLINE void ID2D1DeviceContext4_PushLayer(ID2D1DeviceContext4* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    This->lpVtbl->ID2D1DeviceContext_PushLayer(This,layer_parameters,layer);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_InvalidateEffectInputRectangle(ID2D1DeviceContext4* This,ID2D1Effect *effect,UINT32 input,const D2D1_RECT_F *input_rect) {
    return This->lpVtbl->InvalidateEffectInputRectangle(This,effect,input,input_rect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetEffectInvalidRectangleCount(ID2D1DeviceContext4* This,ID2D1Effect *effect,UINT32 *rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangleCount(This,effect,rect_count);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetEffectInvalidRectangles(ID2D1DeviceContext4* This,ID2D1Effect *effect,D2D1_RECT_F *rectangles,UINT32 rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangles(This,effect,rectangles,rect_count);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetEffectRequiredInputRectangles(ID2D1DeviceContext4* This,ID2D1Effect *effect,const D2D1_RECT_F *image_rect,const D2D1_EFFECT_INPUT_DESCRIPTION *desc,D2D1_RECT_F *input_rect,UINT32 input_count) {
    return This->lpVtbl->GetEffectRequiredInputRectangles(This,effect,image_rect,desc,input_rect,input_count);
}
static __WIDL_INLINE void ID2D1DeviceContext4_FillOpacityMask(ID2D1DeviceContext4* This,ID2D1Bitmap *mask,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext_FillOpacityMask(This,mask,brush,dst_rect,src_rect);
}
/*** ID2D1DeviceContext1 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateFilledGeometryRealization(ID2D1DeviceContext4* This,ID2D1Geometry *geometry,float tolerance,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateFilledGeometryRealization(This,geometry,tolerance,realization);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateStrokedGeometryRealization(ID2D1DeviceContext4* This,ID2D1Geometry *geometry,float tolerance,float stroke_width,ID2D1StrokeStyle *stroke_style,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateStrokedGeometryRealization(This,geometry,tolerance,stroke_width,stroke_style,realization);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawGeometryRealization(ID2D1DeviceContext4* This,ID2D1GeometryRealization *realization,ID2D1Brush *brush) {
    This->lpVtbl->DrawGeometryRealization(This,realization,brush);
}
/*** ID2D1DeviceContext2 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateInk(ID2D1DeviceContext4* This,const D2D1_INK_POINT *start_point,ID2D1Ink **ink) {
    return This->lpVtbl->CreateInk(This,start_point,ink);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateInkStyle(ID2D1DeviceContext4* This,const D2D1_INK_STYLE_PROPERTIES *ink_style_properties,ID2D1InkStyle **ink_style) {
    return This->lpVtbl->CreateInkStyle(This,ink_style_properties,ink_style);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateGradientMesh(ID2D1DeviceContext4* This,const D2D1_GRADIENT_MESH_PATCH *patches,UINT32 patches_count,ID2D1GradientMesh **gradient_mesh) {
    return This->lpVtbl->CreateGradientMesh(This,patches,patches_count,gradient_mesh);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateImageSourceFromWic(ID2D1DeviceContext4* This,IWICBitmapSource *wic_bitmap_source,D2D1_IMAGE_SOURCE_LOADING_OPTIONS loading_options,D2D1_ALPHA_MODE alpha_mode,ID2D1ImageSourceFromWic **image_source) {
    return This->lpVtbl->CreateImageSourceFromWic(This,wic_bitmap_source,loading_options,alpha_mode,image_source);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateLookupTable3D(ID2D1DeviceContext4* This,D2D1_BUFFER_PRECISION precision,const UINT32 *extents,const BYTE *data,UINT32 data_count,const UINT32 *strides,ID2D1LookupTable3D **lookup_table) {
    return This->lpVtbl->CreateLookupTable3D(This,precision,extents,data,data_count,strides,lookup_table);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateImageSourceFromDxgi(ID2D1DeviceContext4* This,IDXGISurface **surfaces,UINT32 surface_count,DXGI_COLOR_SPACE_TYPE color_space,D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options,ID2D1ImageSource **image_source) {
    return This->lpVtbl->CreateImageSourceFromDxgi(This,surfaces,surface_count,color_space,options,image_source);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetGradientMeshWorldBounds(ID2D1DeviceContext4* This,ID2D1GradientMesh *gradient_mesh,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGradientMeshWorldBounds(This,gradient_mesh,bounds);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawInk(ID2D1DeviceContext4* This,ID2D1Ink *ink,ID2D1Brush *brush,ID2D1InkStyle *ink_style) {
    This->lpVtbl->DrawInk(This,ink,brush,ink_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawGradientMesh(ID2D1DeviceContext4* This,ID2D1GradientMesh *gradient_mesh) {
    This->lpVtbl->DrawGradientMesh(This,gradient_mesh);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawGdiMetafile(ID2D1DeviceContext4* This,ID2D1GdiMetafile *gdi_metafile,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext2_DrawGdiMetafile(This,gdi_metafile,dst_rect,src_rect);
}
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateTransformedImageSource(ID2D1DeviceContext4* This,ID2D1ImageSource *source,const D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES *props,ID2D1TransformedImageSource **transformed) {
    return This->lpVtbl->CreateTransformedImageSource(This,source,props,transformed);
}
/*** ID2D1DeviceContext3 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateSpriteBatch(ID2D1DeviceContext4* This,ID2D1SpriteBatch **sprite_batch) {
    return This->lpVtbl->CreateSpriteBatch(This,sprite_batch);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawSpriteBatch(ID2D1DeviceContext4* This,ID2D1SpriteBatch *sprite_batch,UINT32 start_index,UINT32 sprite_count,ID2D1Bitmap *bitmap,D2D1_BITMAP_INTERPOLATION_MODE interpolation_mode,D2D1_SPRITE_OPTIONS sprite_options) {
    This->lpVtbl->DrawSpriteBatch(This,sprite_batch,start_index,sprite_count,bitmap,interpolation_mode,sprite_options);
}
/*** ID2D1DeviceContext4 methods ***/
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_CreateSvgGlyphStyle(ID2D1DeviceContext4* This,ID2D1SvgGlyphStyle **svg_glyph_style) {
    return This->lpVtbl->CreateSvgGlyphStyle(This,svg_glyph_style);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawText(ID2D1DeviceContext4* This,const WCHAR *string,UINT32 string_length,IDWriteTextFormat *text_format,const D2D1_RECT_F *layout_rect,ID2D1Brush *default_fill_brush,ID2D1SvgGlyphStyle *svg_glyph_style,UINT32 color_palette_index,D2D1_DRAW_TEXT_OPTIONS options,DWRITE_MEASURING_MODE measuring_mode) {
...
static __WIDL_INLINE void ID2D1DeviceContext4_DrawTextLayout(ID2D1DeviceContext4* This,D2D1_POINT_2F origin,IDWriteTextLayout *text_layout,ID2D1Brush *default_fill_brush,ID2D1SvgGlyphStyle *svg_glyph_style,UINT32 color_palette_index,D2D1_DRAW_TEXT_OPTIONS options) {
...
static __WIDL_INLINE void ID2D1DeviceContext4_DrawColorBitmapGlyphRun(ID2D1DeviceContext4* This,DWRITE_GLYPH_IMAGE_FORMATS glyph_image_format,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmap_snap_option) {
    This->lpVtbl->DrawColorBitmapGlyphRun(This,glyph_image_format,baseline_origin,glyph_run,measuring_mode,bitmap_snap_option);
}
static __WIDL_INLINE void ID2D1DeviceContext4_DrawSvgGlyphRun(ID2D1DeviceContext4* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,ID2D1Brush *default_fill_brush,ID2D1SvgGlyphStyle *svg_glyph_style,UINT32 color_palette_index,DWRITE_MEASURING_MODE measuring_mode) {
...
static __WIDL_INLINE HRESULT ID2D1DeviceContext4_GetColorBitmapGlyphImage(ID2D1DeviceContext4* This,DWRITE_GLYPH_IMAGE_FORMATS glyph_image_format,D2D1_POINT_2F glyph_origin,IDWriteFontFace *font_face,FLOAT font_em_size,UINT16 glyph_index,BOOL is_sideways,const D2D1_MATRIX_3X2_F *world_transform,FLOAT dpi_x,FLOAT dpi_y,D2D1_MATRIX_3X2_F *glyph_transform,ID2D1Image **glyph_image) {
...
static __WIDL_INLINE HRESULT ID2D1Factory3_RegisterEffectFromStream(ID2D1Factory3* This,REFCLSID effect_id,IStream *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromStream(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static __WIDL_INLINE HRESULT ID2D1Factory3_RegisterEffectFromString(ID2D1Factory3* This,REFCLSID effect_id,const WCHAR *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
