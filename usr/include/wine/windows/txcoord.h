/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/txcoord.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionResourceAsync_QueryInterface(ITransactionResourceAsync* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionResourceAsync_AddRef(ITransactionResourceAsync* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionResourceAsync_Release(ITransactionResourceAsync* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionResourceAsync methods ***/
static __WIDL_INLINE HRESULT ITransactionResourceAsync_PrepareRequest(ITransactionResourceAsync* This,BOOL fRetaining,DWORD grfRM,BOOL fWantMoniker,BOOL fSinglePhase) {
    return This->lpVtbl->PrepareRequest(This,fRetaining,grfRM,fWantMoniker,fSinglePhase);
}
static __WIDL_INLINE HRESULT ITransactionResourceAsync_CommitRequest(ITransactionResourceAsync* This,DWORD grfRM,XACTUOW *pNewUOW) {
    return This->lpVtbl->CommitRequest(This,grfRM,pNewUOW);
}
static __WIDL_INLINE HRESULT ITransactionResourceAsync_AbortRequest(ITransactionResourceAsync* This,BOID *pboidReason,BOOL fRetaining,XACTUOW *pNewUOW) {
    return This->lpVtbl->AbortRequest(This,pboidReason,fRetaining,pNewUOW);
}
static __WIDL_INLINE HRESULT ITransactionResourceAsync_TMDown(ITransactionResourceAsync* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionLastResourceAsync_QueryInterface(ITransactionLastResourceAsync* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionLastResourceAsync_AddRef(ITransactionLastResourceAsync* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionLastResourceAsync_Release(ITransactionLastResourceAsync* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionLastResourceAsync methods ***/
static __WIDL_INLINE HRESULT ITransactionLastResourceAsync_DelegateCommit(ITransactionLastResourceAsync* This,DWORD grfRM) {
    return This->lpVtbl->DelegateCommit(This,grfRM);
}
static __WIDL_INLINE HRESULT ITransactionLastResourceAsync_ForgetRequest(ITransactionLastResourceAsync* This,XACTUOW *pNewUOW) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionResource_QueryInterface(ITransactionResource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionResource_AddRef(ITransactionResource* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionResource_Release(ITransactionResource* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionResource methods ***/
static __WIDL_INLINE HRESULT ITransactionResource_PrepareRequest(ITransactionResource* This,BOOL fRetaining,DWORD grfRM,BOOL fWantMoniker,BOOL fSinglePhase) {
    return This->lpVtbl->PrepareRequest(This,fRetaining,grfRM,fWantMoniker,fSinglePhase);
}
static __WIDL_INLINE HRESULT ITransactionResource_CommitRequest(ITransactionResource* This,DWORD grfRM,XACTUOW *pNewUOW) {
    return This->lpVtbl->CommitRequest(This,grfRM,pNewUOW);
}
static __WIDL_INLINE HRESULT ITransactionResource_AbortRequest(ITransactionResource* This,BOID *pboidReason,BOOL fRetaining,XACTUOW *pNewUOW) {
    return This->lpVtbl->AbortRequest(This,pboidReason,fRetaining,pNewUOW);
}
static __WIDL_INLINE HRESULT ITransactionResource_TMDown(ITransactionResource* This) {
    return This->lpVtbl->TMDown(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionEnlistmentAsync_QueryInterface(ITransactionEnlistmentAsync* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionEnlistmentAsync_AddRef(ITransactionEnlistmentAsync* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionEnlistmentAsync_Release(ITransactionEnlistmentAsync* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionEnlistmentAsync methods ***/
static __WIDL_INLINE HRESULT ITransactionEnlistmentAsync_PrepareRequestDone(ITransactionEnlistmentAsync* This,HRESULT hr,IMoniker *pmk,BOID *pboidReason) {
    return This->lpVtbl->PrepareRequestDone(This,hr,pmk,pboidReason);
}
static __WIDL_INLINE HRESULT ITransactionEnlistmentAsync_CommitRequestDone(ITransactionEnlistmentAsync* This,HRESULT hr) {
    return This->lpVtbl->CommitRequestDone(This,hr);
}
static __WIDL_INLINE HRESULT ITransactionEnlistmentAsync_AbortRequestDone(ITransactionEnlistmentAsync* This,HRESULT hr) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionLastEnlistmentAsync_QueryInterface(ITransactionLastEnlistmentAsync* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionLastEnlistmentAsync_AddRef(ITransactionLastEnlistmentAsync* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionLastEnlistmentAsync_Release(ITransactionLastEnlistmentAsync* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionLastEnlistmentAsync methods ***/
static __WIDL_INLINE HRESULT ITransactionLastEnlistmentAsync_TransactionOutcome(ITransactionLastEnlistmentAsync* This,XACTSTAT XactStat,BOID *pboidReason) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionExportFactory_QueryInterface(ITransactionExportFactory* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionExportFactory_AddRef(ITransactionExportFactory* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionExportFactory_Release(ITransactionExportFactory* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionExportFactory methods ***/
static __WIDL_INLINE HRESULT ITransactionExportFactory_GetRemoteClassId(ITransactionExportFactory* This,CLSID *pclsid) {
    return This->lpVtbl->GetRemoteClassId(This,pclsid);
}
static __WIDL_INLINE HRESULT ITransactionExportFactory_Create(ITransactionExportFactory* This,ULONG cbWhereabouts,byte *rgbWhereabouts,ITransactionExport **ppExport) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionImportWhereabouts_QueryInterface(ITransactionImportWhereabouts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionImportWhereabouts_AddRef(ITransactionImportWhereabouts* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionImportWhereabouts_Release(ITransactionImportWhereabouts* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionImportWhereabouts methods ***/
static __WIDL_INLINE HRESULT ITransactionImportWhereabouts_GetWhereaboutsSize(ITransactionImportWhereabouts* This,ULONG *pcbWhereabouts) {
    return This->lpVtbl->GetWhereaboutsSize(This,pcbWhereabouts);
}
static __WIDL_INLINE HRESULT ITransactionImportWhereabouts_GetWhereabouts(ITransactionImportWhereabouts* This,ULONG cbWhereabouts,byte *rgbWhereabouts,ULONG *pcbUsed) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionExport_QueryInterface(ITransactionExport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionExport_AddRef(ITransactionExport* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionExport_Release(ITransactionExport* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionExport methods ***/
static __WIDL_INLINE HRESULT ITransactionExport_Export(ITransactionExport* This,IUnknown *punkTransaction,ULONG *pcbTransactionCookie) {
    return This->lpVtbl->Export(This,punkTransaction,pcbTransactionCookie);
}
static __WIDL_INLINE HRESULT ITransactionExport_GetTransactionCookie(ITransactionExport* This,IUnknown *punkTransaction,ULONG cbTransactionCookie,byte *rgbTransactionCookie,ULONG *pcbUsed) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITransactionImport_QueryInterface(ITransactionImport* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITransactionImport_AddRef(ITransactionImport* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITransactionImport_Release(ITransactionImport* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionImport methods ***/
static __WIDL_INLINE HRESULT ITransactionImport_Import(ITransactionImport* This,ULONG cbTransactionCookie,byte *rgbTransactionCookie,IID *piid,void **ppvTransaction) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITipTransaction_QueryInterface(ITipTransaction* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITipTransaction_AddRef(ITipTransaction* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITipTransaction_Release(ITipTransaction* This) {
    return This->lpVtbl->Release(This);
}
/*** ITipTransaction methods ***/
static __WIDL_INLINE HRESULT ITipTransaction_Push(ITipTransaction* This,char *i_pszRemoteTmUrl,char **o_ppszRemoteTxUrl) {
    return This->lpVtbl->Push(This,i_pszRemoteTmUrl,o_ppszRemoteTxUrl);
}
static __WIDL_INLINE HRESULT ITipTransaction_GetTransactionUrl(ITipTransaction* This,char **o_ppszLocalTxUrl) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITipHelper_QueryInterface(ITipHelper* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITipHelper_AddRef(ITipHelper* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITipHelper_Release(ITipHelper* This) {
    return This->lpVtbl->Release(This);
}
/*** ITipHelper methods ***/
static __WIDL_INLINE HRESULT ITipHelper_Pull(ITipHelper* This,char *i_pszTxUrl,ITransaction **o_ppITransaction) {
    return This->lpVtbl->Pull(This,i_pszTxUrl,o_ppITransaction);
}
static __WIDL_INLINE HRESULT ITipHelper_PullAsync(ITipHelper* This,char *i_pszTxUrl,ITipPullSink *i_pTipPullSink,ITransaction **o_ppITransaction) {
    return This->lpVtbl->PullAsync(This,i_pszTxUrl,i_pTipPullSink,o_ppITransaction);
}
static __WIDL_INLINE HRESULT ITipHelper_GetLocalTmUrl(ITipHelper* This,char **o_ppszLocalTmUrl) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ITipPullSink_QueryInterface(ITipPullSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ITipPullSink_AddRef(ITipPullSink* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ITipPullSink_Release(ITipPullSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ITipPullSink methods ***/
static __WIDL_INLINE HRESULT ITipPullSink_PullComplete(ITipPullSink* This,HRESULT i_hrPull) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_QueryInterface(IDtcNetworkAccessConfig* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDtcNetworkAccessConfig_AddRef(IDtcNetworkAccessConfig* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDtcNetworkAccessConfig_Release(IDtcNetworkAccessConfig* This) {
    return This->lpVtbl->Release(This);
}
/*** IDtcNetworkAccessConfig methods ***/
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetAnyNetworkAccess(IDtcNetworkAccessConfig* This,BOOL *pbAnyNetworkAccess) {
    return This->lpVtbl->GetAnyNetworkAccess(This,pbAnyNetworkAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetAnyNetworkAccess(IDtcNetworkAccessConfig* This,BOOL bAnyNetworkAccess) {
    return This->lpVtbl->SetAnyNetworkAccess(This,bAnyNetworkAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetNetworkAdministrationAccess(IDtcNetworkAccessConfig* This,BOOL *pbNetworkAdministrationAccess) {
    return This->lpVtbl->GetNetworkAdministrationAccess(This,pbNetworkAdministrationAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetNetworkAdministrationAccess(IDtcNetworkAccessConfig* This,BOOL bNetworkAdministrationAccess) {
    return This->lpVtbl->SetNetworkAdministrationAccess(This,bNetworkAdministrationAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetNetworkTransactionAccess(IDtcNetworkAccessConfig* This,BOOL *pbNetworkTransactionAccess) {
    return This->lpVtbl->GetNetworkTransactionAccess(This,pbNetworkTransactionAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetNetworkTransactionAccess(IDtcNetworkAccessConfig* This,BOOL bNetworkTransactionAccess) {
    return This->lpVtbl->SetNetworkTransactionAccess(This,bNetworkTransactionAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetNetworkClientAccess(IDtcNetworkAccessConfig* This,BOOL *pbNetworkClientAccess) {
    return This->lpVtbl->GetNetworkClientAccess(This,pbNetworkClientAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetNetworkClientAccess(IDtcNetworkAccessConfig* This,BOOL bNetworkClientAccess) {
    return This->lpVtbl->SetNetworkClientAccess(This,bNetworkClientAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetNetworkTIPAccess(IDtcNetworkAccessConfig* This,BOOL *pbNetworkTIPAccess) {
    return This->lpVtbl->GetNetworkTIPAccess(This,pbNetworkTIPAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetNetworkTIPAccess(IDtcNetworkAccessConfig* This,BOOL bNetworkTIPAccess) {
    return This->lpVtbl->SetNetworkTIPAccess(This,bNetworkTIPAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_GetXAAccess(IDtcNetworkAccessConfig* This,BOOL *pbXAAccess) {
    return This->lpVtbl->GetXAAccess(This,pbXAAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_SetXAAccess(IDtcNetworkAccessConfig* This,BOOL bXAAccess) {
    return This->lpVtbl->SetXAAccess(This,bXAAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig_RestartDtcService(IDtcNetworkAccessConfig* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_QueryInterface(IDtcNetworkAccessConfig2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IDtcNetworkAccessConfig2_AddRef(IDtcNetworkAccessConfig2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IDtcNetworkAccessConfig2_Release(IDtcNetworkAccessConfig2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDtcNetworkAccessConfig methods ***/
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetAnyNetworkAccess(IDtcNetworkAccessConfig2* This,BOOL *pbAnyNetworkAccess) {
    return This->lpVtbl->GetAnyNetworkAccess(This,pbAnyNetworkAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetAnyNetworkAccess(IDtcNetworkAccessConfig2* This,BOOL bAnyNetworkAccess) {
    return This->lpVtbl->SetAnyNetworkAccess(This,bAnyNetworkAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkAdministrationAccess(IDtcNetworkAccessConfig2* This,BOOL *pbNetworkAdministrationAccess) {
    return This->lpVtbl->GetNetworkAdministrationAccess(This,pbNetworkAdministrationAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkAdministrationAccess(IDtcNetworkAccessConfig2* This,BOOL bNetworkAdministrationAccess) {
    return This->lpVtbl->SetNetworkAdministrationAccess(This,bNetworkAdministrationAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkTransactionAccess(IDtcNetworkAccessConfig2* This,BOOL *pbNetworkTransactionAccess) {
    return This->lpVtbl->GetNetworkTransactionAccess(This,pbNetworkTransactionAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkTransactionAccess(IDtcNetworkAccessConfig2* This,BOOL bNetworkTransactionAccess) {
    return This->lpVtbl->SetNetworkTransactionAccess(This,bNetworkTransactionAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkClientAccess(IDtcNetworkAccessConfig2* This,BOOL *pbNetworkClientAccess) {
    return This->lpVtbl->GetNetworkClientAccess(This,pbNetworkClientAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkClientAccess(IDtcNetworkAccessConfig2* This,BOOL bNetworkClientAccess) {
    return This->lpVtbl->SetNetworkClientAccess(This,bNetworkClientAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkTIPAccess(IDtcNetworkAccessConfig2* This,BOOL *pbNetworkTIPAccess) {
    return This->lpVtbl->GetNetworkTIPAccess(This,pbNetworkTIPAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkTIPAccess(IDtcNetworkAccessConfig2* This,BOOL bNetworkTIPAccess) {
    return This->lpVtbl->SetNetworkTIPAccess(This,bNetworkTIPAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetXAAccess(IDtcNetworkAccessConfig2* This,BOOL *pbXAAccess) {
    return This->lpVtbl->GetXAAccess(This,pbXAAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetXAAccess(IDtcNetworkAccessConfig2* This,BOOL bXAAccess) {
    return This->lpVtbl->SetXAAccess(This,bXAAccess);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_RestartDtcService(IDtcNetworkAccessConfig2* This) {
    return This->lpVtbl->RestartDtcService(This);
}
/*** IDtcNetworkAccessConfig2 methods ***/
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkInboundAccess(IDtcNetworkAccessConfig2* This,BOOL *pbInbound) {
    return This->lpVtbl->GetNetworkInboundAccess(This,pbInbound);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetNetworkOutboundAccess(IDtcNetworkAccessConfig2* This,BOOL *pbOutbound) {
    return This->lpVtbl->GetNetworkOutboundAccess(This,pbOutbound);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkInboundAccess(IDtcNetworkAccessConfig2* This,BOOL bInbound) {
    return This->lpVtbl->SetNetworkInboundAccess(This,bInbound);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetNetworkOutboundAccess(IDtcNetworkAccessConfig2* This,BOOL bOutbound) {
    return This->lpVtbl->SetNetworkOutboundAccess(This,bOutbound);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_GetAuthenticationLevel(IDtcNetworkAccessConfig2* This,AUTHENTICATION_LEVEL *pAuthLevel) {
    return This->lpVtbl->GetAuthenticationLevel(This,pAuthLevel);
}
static __WIDL_INLINE HRESULT IDtcNetworkAccessConfig2_SetAuthenticationLevel(IDtcNetworkAccessConfig2* This,AUTHENTICATION_LEVEL AuthLevel) {
