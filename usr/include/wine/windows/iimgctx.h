/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/iimgctx.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IImgCtx_QueryInterface(IImgCtx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IImgCtx_AddRef(IImgCtx* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IImgCtx_Release(IImgCtx* This) {
    return This->lpVtbl->Release(This);
}
/*** IImgCtx methods ***/
static __WIDL_INLINE HRESULT IImgCtx_Load(IImgCtx* This,LPCWSTR url,DWORD flags) {
    return This->lpVtbl->Load(This,url,flags);
}
static __WIDL_INLINE HRESULT IImgCtx_SelectChanges(IImgCtx* This,ULONG changeon,ULONG changeoff,BOOL signal) {
    return This->lpVtbl->SelectChanges(This,changeon,changeoff,signal);
}
static __WIDL_INLINE HRESULT IImgCtx_SetCallback(IImgCtx* This,PFNIMGCTXCALLBACK fn,void *priv) {
    return This->lpVtbl->SetCallback(This,fn,priv);
}
static __WIDL_INLINE HRESULT IImgCtx_Disconnect(IImgCtx* This) {
    return This->lpVtbl->Disconnect(This);
}
static __WIDL_INLINE HRESULT IImgCtx_GetUpdateRects(IImgCtx* This,RECT *rect,RECT *img,LONG *pcrc) {
    return This->lpVtbl->GetUpdateRects(This,rect,img,pcrc);
}
static __WIDL_INLINE HRESULT IImgCtx_GetStateInfo(IImgCtx* This,ULONG *state,SIZE *size,BOOL clear_changes) {
    return This->lpVtbl->GetStateInfo(This,state,size,clear_changes);
}
static __WIDL_INLINE HRESULT IImgCtx_GetPalette(IImgCtx* This,HPALETTE *hpal) {
    return This->lpVtbl->GetPalette(This,hpal);
}
static __WIDL_INLINE HRESULT IImgCtx_Draw(IImgCtx* This,HDC hdc,RECT *bounds) {
    return This->lpVtbl->Draw(This,hdc,bounds);
}
static __WIDL_INLINE HRESULT IImgCtx_Tile(IImgCtx* This,HDC hdc,POINT *backorg,RECT *clip,SIZE *size) {
    return This->lpVtbl->Tile(This,hdc,backorg,clip,size);
}
static __WIDL_INLINE HRESULT IImgCtx_StretchBlt(IImgCtx* This,HDC hdc,int dstX,int dstY,int dstXE,int dstYE,int srcX,int srcY,int srcXE,int srcYE,DWORD rop) {
