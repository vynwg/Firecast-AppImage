/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/textstor.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT ITextStoreACP_QueryInsertEmbedded(ITextStoreACP* This,const GUID *pguidService,const FORMATETC *pFormatEtc,BOOL *pfInsertable) {
...
static __WIDL_INLINE HRESULT ITextStoreACP_FindNextAttrTransition(ITextStoreACP* This,LONG acpStart,LONG acpHalt,ULONG cFilterAttrs,const TS_ATTRID *paFilterAttrs,DWORD dwFlags,LONG *pacpNext,BOOL *pfFound,LONG *plFoundOffset) {
...
static __WIDL_INLINE HRESULT ITextStoreACP_GetTextExt(ITextStoreACP* This,TsViewCookie vcView,LONG acpStart,LONG acpEnd,RECT *prc,BOOL *pfClipped) {
