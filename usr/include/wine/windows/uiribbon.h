/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/uiribbon.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUISimplePropertySet_QueryInterface(IUISimplePropertySet* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUISimplePropertySet_AddRef(IUISimplePropertySet* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUISimplePropertySet_Release(IUISimplePropertySet* This) {
    return This->lpVtbl->Release(This);
}
/*** IUISimplePropertySet methods ***/
static __WIDL_INLINE HRESULT IUISimplePropertySet_GetValue(IUISimplePropertySet* This,REFPROPERTYKEY key,PROPVARIANT *value) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUICommandHandler_QueryInterface(IUICommandHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUICommandHandler_AddRef(IUICommandHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUICommandHandler_Release(IUICommandHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IUICommandHandler methods ***/
static __WIDL_INLINE HRESULT IUICommandHandler_Execute(IUICommandHandler* This,UINT32 commandId,UI_EXECUTIONVERB verb,const PROPERTYKEY *key,const PROPVARIANT *currentValue,IUISimplePropertySet *commandExecutionProperties) {
    return This->lpVtbl->Execute(This,commandId,verb,key,currentValue,commandExecutionProperties);
}
static __WIDL_INLINE HRESULT IUICommandHandler_UpdateProperty(IUICommandHandler* This,UINT32 commandId,REFPROPERTYKEY key,const PROPVARIANT *currentValue,PROPVARIANT *newValue) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIApplication_QueryInterface(IUIApplication* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIApplication_AddRef(IUIApplication* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIApplication_Release(IUIApplication* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIApplication methods ***/
static __WIDL_INLINE HRESULT IUIApplication_OnViewChanged(IUIApplication* This,UINT32 viewId,UI_VIEWTYPE typeID,IUnknown *view,UI_VIEWVERB verb,INT32 uReasonCode) {
    return This->lpVtbl->OnViewChanged(This,viewId,typeID,view,verb,uReasonCode);
}
static __WIDL_INLINE HRESULT IUIApplication_OnCreateUICommand(IUIApplication* This,UINT32 commandId,UI_COMMANDTYPE typeID,IUICommandHandler **commandHandler) {
    return This->lpVtbl->OnCreateUICommand(This,commandId,typeID,commandHandler);
}
static __WIDL_INLINE HRESULT IUIApplication_OnDestroyUICommand(IUIApplication* This,UINT32 commandId,UI_COMMANDTYPE typeID,IUICommandHandler *commandHandler) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIFramework_QueryInterface(IUIFramework* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIFramework_AddRef(IUIFramework* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIFramework_Release(IUIFramework* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIFramework methods ***/
static __WIDL_INLINE HRESULT IUIFramework_Initialize(IUIFramework* This,HWND frameWnd,IUIApplication *application) {
    return This->lpVtbl->Initialize(This,frameWnd,application);
}
static __WIDL_INLINE HRESULT IUIFramework_Destroy(IUIFramework* This) {
    return This->lpVtbl->Destroy(This);
}
static __WIDL_INLINE HRESULT IUIFramework_LoadUI(IUIFramework* This,HINSTANCE instance,LPCWSTR resourceName) {
    return This->lpVtbl->LoadUI(This,instance,resourceName);
}
static __WIDL_INLINE HRESULT IUIFramework_GetView(IUIFramework* This,UINT32 viewId,REFIID riid,void **ppv) {
    return This->lpVtbl->GetView(This,viewId,riid,ppv);
}
static __WIDL_INLINE HRESULT IUIFramework_GetUICommandProperty(IUIFramework* This,UINT32 commandId,REFPROPERTYKEY key,PROPVARIANT *value) {
    return This->lpVtbl->GetUICommandProperty(This,commandId,key,value);
}
static __WIDL_INLINE HRESULT IUIFramework_SetUICommandProperty(IUIFramework* This,UINT32 commandId,REFPROPERTYKEY key,REFPROPVARIANT value) {
    return This->lpVtbl->SetUICommandProperty(This,commandId,key,value);
}
static __WIDL_INLINE HRESULT IUIFramework_InvalidateUICommand(IUIFramework* This,UINT32 commandId,UI_INVALIDATIONS flags,const PROPERTYKEY *key) {
    return This->lpVtbl->InvalidateUICommand(This,commandId,flags,key);
}
static __WIDL_INLINE HRESULT IUIFramework_FlushPendingInvalidations(IUIFramework* This) {
    return This->lpVtbl->FlushPendingInvalidations(This);
}
static __WIDL_INLINE HRESULT IUIFramework_SetModes(IUIFramework* This,INT32 iModes) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIImage_QueryInterface(IUIImage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIImage_AddRef(IUIImage* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIImage_Release(IUIImage* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIImage methods ***/
static __WIDL_INLINE HRESULT IUIImage_GetBitmap(IUIImage* This,HBITMAP *bitmap) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIRibbon_QueryInterface(IUIRibbon* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIRibbon_AddRef(IUIRibbon* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIRibbon_Release(IUIRibbon* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIRibbon methods ***/
static __WIDL_INLINE HRESULT IUIRibbon_GetHeight(IUIRibbon* This,UINT32 *cy) {
    return This->lpVtbl->GetHeight(This,cy);
}
static __WIDL_INLINE HRESULT IUIRibbon_LoadSettingsFromStream(IUIRibbon* This,IStream *pStream) {
    return This->lpVtbl->LoadSettingsFromStream(This,pStream);
}
static __WIDL_INLINE HRESULT IUIRibbon_SaveSettingsToStream(IUIRibbon* This,IStream *pStream) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUICollection_QueryInterface(IUICollection* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUICollection_AddRef(IUICollection* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUICollection_Release(IUICollection* This) {
    return This->lpVtbl->Release(This);
}
/*** IUICollection methods ***/
static __WIDL_INLINE HRESULT IUICollection_GetCount(IUICollection* This,UINT32 *count) {
    return This->lpVtbl->GetCount(This,count);
}
static __WIDL_INLINE HRESULT IUICollection_GetItem(IUICollection* This,UINT32 index,IUnknown **item) {
    return This->lpVtbl->GetItem(This,index,item);
}
static __WIDL_INLINE HRESULT IUICollection_Add(IUICollection* This,IUnknown *item) {
    return This->lpVtbl->Add(This,item);
}
static __WIDL_INLINE HRESULT IUICollection_Insert(IUICollection* This,UINT32 index,IUnknown *item) {
    return This->lpVtbl->Insert(This,index,item);
}
static __WIDL_INLINE HRESULT IUICollection_RemoveAt(IUICollection* This,UINT32 index) {
    return This->lpVtbl->RemoveAt(This,index);
}
static __WIDL_INLINE HRESULT IUICollection_Replace(IUICollection* This,UINT32 indexReplaced,IUnknown *itemReplaceWith) {
    return This->lpVtbl->Replace(This,indexReplaced,itemReplaceWith);
}
static __WIDL_INLINE HRESULT IUICollection_Clear(IUICollection* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIContextualUI_QueryInterface(IUIContextualUI* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIContextualUI_AddRef(IUIContextualUI* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIContextualUI_Release(IUIContextualUI* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIContextualUI methods ***/
static __WIDL_INLINE HRESULT IUIContextualUI_ShowAtLocation(IUIContextualUI* This,INT32 x,INT32 y) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUICollectionChangedEvent_QueryInterface(IUICollectionChangedEvent* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUICollectionChangedEvent_AddRef(IUICollectionChangedEvent* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUICollectionChangedEvent_Release(IUICollectionChangedEvent* This) {
    return This->lpVtbl->Release(This);
}
/*** IUICollectionChangedEvent methods ***/
static __WIDL_INLINE HRESULT IUICollectionChangedEvent_OnChanged(IUICollectionChangedEvent* This,UI_COLLECTIONCHANGE action,UINT32 oldIndex,IUnknown *oldItem,UINT32 newIndex,IUnknown *newItem) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUIImageFromBitmap_QueryInterface(IUIImageFromBitmap* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUIImageFromBitmap_AddRef(IUIImageFromBitmap* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUIImageFromBitmap_Release(IUIImageFromBitmap* This) {
    return This->lpVtbl->Release(This);
}
/*** IUIImageFromBitmap methods ***/
static __WIDL_INLINE HRESULT IUIImageFromBitmap_CreateImage(IUIImageFromBitmap* This,HBITMAP bitmap,UI_OWNERSHIP options,IUIImage **image) {
