/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d2d1_1.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT ID2D1PathGeometry1_StrokeContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
    return This->lpVtbl->StrokeContainsPoint(This,point,stroke_width,stroke_style,transform,tolerance,contains);
}
static __WIDL_INLINE HRESULT ID2D1PathGeometry1_FillContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
