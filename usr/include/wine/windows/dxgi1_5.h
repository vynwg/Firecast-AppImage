/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/dxgi1_5.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IDXGIOutput5_TakeOwnership(IDXGIOutput5* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static __WIDL_INLINE BOOL IDXGIOutput5_SupportsOverlays(IDXGIOutput5* This) {
...
static __WIDL_INLINE HRESULT IDXGISwapChain4_SetFullscreenState(IDXGISwapChain4* This,BOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static __WIDL_INLINE HRESULT IDXGISwapChain4_GetFullscreenState(IDXGISwapChain4* This,BOOL *fullscreen,IDXGIOutput **target) {
...
static __WIDL_INLINE BOOL IDXGISwapChain4_IsTemporaryMonoSupported(IDXGISwapChain4* This) {
...
static __WIDL_INLINE HRESULT IDXGIDevice4_ReclaimResources(IDXGIDevice4* This,UINT NumResources,IDXGIResource *const *ppResources,BOOL *pDiscarded) {
...
static __WIDL_INLINE BOOL IDXGIFactory5_IsCurrent(IDXGIFactory5* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static __WIDL_INLINE BOOL IDXGIFactory5_IsWindowedStereoEnabled(IDXGIFactory5* This) {
