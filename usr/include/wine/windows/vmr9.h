/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/vmr9.idl - Do not edit ***/
...
/*** IVMRVideoStreamControl9 methods ***/
static __WIDL_INLINE HRESULT IVMRVideoStreamControl9_SetStreamActiveState(IVMRVideoStreamControl9* This,BOOL active) {
    return This->lpVtbl->SetStreamActiveState(This,active);
}
static __WIDL_INLINE HRESULT IVMRVideoStreamControl9_GetStreamActiveState(IVMRVideoStreamControl9* This,BOOL *active) {
...
static __WIDL_INLINE HRESULT IVMRImageCompositor9_SetStreamMediaType(IVMRImageCompositor9* This,DWORD stream,AM_MEDIA_TYPE *mt,BOOL texture) {
