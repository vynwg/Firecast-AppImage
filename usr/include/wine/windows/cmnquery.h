/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/cmnquery.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IPersistQuery_QueryInterface(IPersistQuery* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IPersistQuery_AddRef(IPersistQuery* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IPersistQuery_Release(IPersistQuery* This) {
    return This->lpVtbl->Release(This);
}
/*** IPersist methods ***/
static __WIDL_INLINE HRESULT IPersistQuery_GetClassID(IPersistQuery* This,CLSID *pClassID) {
    return This->lpVtbl->GetClassID(This,pClassID);
}
/*** IPersistQuery methods ***/
static __WIDL_INLINE HRESULT IPersistQuery_WriteString(IPersistQuery* This,LPCWSTR section,LPCWSTR name,LPCWSTR value) {
    return This->lpVtbl->WriteString(This,section,name,value);
}
static __WIDL_INLINE HRESULT IPersistQuery_ReadString(IPersistQuery* This,LPCWSTR section,LPCWSTR name,LPWSTR buffer,INT buflen) {
    return This->lpVtbl->ReadString(This,section,name,buffer,buflen);
}
static __WIDL_INLINE HRESULT IPersistQuery_WriteInt(IPersistQuery* This,LPCWSTR section,LPCWSTR name,INT value) {
    return This->lpVtbl->WriteInt(This,section,name,value);
}
static __WIDL_INLINE HRESULT IPersistQuery_ReadInt(IPersistQuery* This,LPCWSTR section,LPCWSTR name,INT *value) {
    return This->lpVtbl->ReadInt(This,section,name,value);
}
static __WIDL_INLINE HRESULT IPersistQuery_WriteStruct(IPersistQuery* This,LPCWSTR section,LPCWSTR name,LPVOID value,DWORD size) {
    return This->lpVtbl->WriteStruct(This,section,name,value,size);
}
static __WIDL_INLINE HRESULT IPersistQuery_ReadStruct(IPersistQuery* This,LPCWSTR section,LPCWSTR name,LPVOID buffer,DWORD buflen) {
    return This->lpVtbl->ReadStruct(This,section,name,buffer,buflen);
}
static __WIDL_INLINE HRESULT IPersistQuery_Clear(IPersistQuery* This) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ICommonQuery_QueryInterface(ICommonQuery* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ICommonQuery_AddRef(ICommonQuery* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ICommonQuery_Release(ICommonQuery* This) {
    return This->lpVtbl->Release(This);
}
/*** ICommonQuery methods ***/
static __WIDL_INLINE HRESULT ICommonQuery_OpenQueryWindow(ICommonQuery* This,HWND parent,LPOPENQUERYWINDOW query_window,IDataObject **data_object) {
