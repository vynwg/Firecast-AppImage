/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/dxva2api.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IDirect3DDeviceManager9_LockDevice(IDirect3DDeviceManager9* This,HANDLE hDevice,IDirect3DDevice9 **ppDevice,BOOL fBlock) {
    return This->lpVtbl->LockDevice(This,hDevice,ppDevice,fBlock);
}
static __WIDL_INLINE HRESULT IDirect3DDeviceManager9_UnlockDevice(IDirect3DDeviceManager9* This,HANDLE hDevice,BOOL fSaveState) {
