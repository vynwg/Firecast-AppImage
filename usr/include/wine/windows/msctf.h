/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/msctf.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IEnumTfPropertyValue_QueryInterface(IEnumTfPropertyValue* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IEnumTfPropertyValue_AddRef(IEnumTfPropertyValue* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IEnumTfPropertyValue_Release(IEnumTfPropertyValue* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumTfPropertyValue methods ***/
static __WIDL_INLINE HRESULT IEnumTfPropertyValue_Clone(IEnumTfPropertyValue* This,IEnumTfPropertyValue **property_value) {
    return This->lpVtbl->Clone(This,property_value);
}
static __WIDL_INLINE HRESULT IEnumTfPropertyValue_Next(IEnumTfPropertyValue* This,ULONG count,TF_PROPERTYVAL *values,ULONG *fetched) {
    return This->lpVtbl->Next(This,count,values,fetched);
}
static __WIDL_INLINE HRESULT IEnumTfPropertyValue_Reset(IEnumTfPropertyValue* This) {
    return This->lpVtbl->Reset(This);
}
static __WIDL_INLINE HRESULT IEnumTfPropertyValue_Skip(IEnumTfPropertyValue* This,ULONG count) {
    return This->lpVtbl->Skip(This,count);
}
#endif
#endif
