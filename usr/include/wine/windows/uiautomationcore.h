/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/uiautomationcore.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IRangeValueProvider_get_IsReadOnly(IRangeValueProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ISelectionProvider_get_CanSelectMultiple(ISelectionProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanSelectMultiple(This,pRetVal);
}
static __WIDL_INLINE HRESULT ISelectionProvider_get_IsSelectionRequired(ISelectionProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT IScrollProvider_get_HorizontallyScrollable(IScrollProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_HorizontallyScrollable(This,pRetVal);
}
static __WIDL_INLINE HRESULT IScrollProvider_get_VerticallyScrollable(IScrollProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ISelectionItemProvider_get_IsSelected(ISelectionItemProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ITransformProvider_get_CanMove(ITransformProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMove(This,pRetVal);
}
static __WIDL_INLINE HRESULT ITransformProvider_get_CanResize(ITransformProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanResize(This,pRetVal);
}
static __WIDL_INLINE HRESULT ITransformProvider_get_CanRotate(ITransformProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT IValueProvider_get_IsReadOnly(IValueProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_IsReadOnly(This,pRetVal);
}
#endif
#endif
...
static __WIDL_INLINE HRESULT IWindowProvider_WaitForInputIdle(IWindowProvider* This,int milliseconds,BOOL *pRetVal) {
    return This->lpVtbl->WaitForInputIdle(This,milliseconds,pRetVal);
}
static __WIDL_INLINE HRESULT IWindowProvider_get_CanMaximize(IWindowProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMaximize(This,pRetVal);
}
static __WIDL_INLINE HRESULT IWindowProvider_get_CanMinimize(IWindowProvider* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMinimize(This,pRetVal);
}
static __WIDL_INLINE HRESULT IWindowProvider_get_IsModal(IWindowProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT IWindowProvider_get_IsTopmost(IWindowProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ITransformProvider2_get_CanMove(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanMove(This,pRetVal);
}
static __WIDL_INLINE HRESULT ITransformProvider2_get_CanResize(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanResize(This,pRetVal);
}
static __WIDL_INLINE HRESULT ITransformProvider2_get_CanRotate(ITransformProvider2* This,BOOL *pRetVal) {
    return This->lpVtbl->get_CanRotate(This,pRetVal);
}
/*** ITransformProvider2 methods ***/
...
static __WIDL_INLINE HRESULT ITransformProvider2_get_CanZoom(ITransformProvider2* This,BOOL *pRetVal) {
...
/*** IDragProvider methods ***/
static __WIDL_INLINE HRESULT IDragProvider_get_IsGrabbed(IDragProvider* This,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ITextProvider2_GetCaretRange(ITextProvider2* This,BOOL *isActive,ITextRangeProvider **pRetVal) {
...
static __WIDL_INLINE HRESULT ITextRangeProvider_Compare(ITextRangeProvider* This,ITextRangeProvider *range,BOOL *pRetVal) {
...
static __WIDL_INLINE HRESULT ITextRangeProvider_FindAttribute(ITextRangeProvider* This,TEXTATTRIBUTEID attributeId,VARIANT val,BOOL backward,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindAttribute(This,attributeId,val,backward,pRetVal);
}
static __WIDL_INLINE HRESULT ITextRangeProvider_FindText(ITextRangeProvider* This,BSTR text,BOOL backward,BOOL ignoreCase,ITextRangeProvider **pRetVal) {
...
static __WIDL_INLINE HRESULT ITextRangeProvider_ScrollIntoView(ITextRangeProvider* This,BOOL alignToTop) {
...
static __WIDL_INLINE HRESULT ITextRangeProvider2_Compare(ITextRangeProvider2* This,ITextRangeProvider *range,BOOL *pRetVal) {
    return This->lpVtbl->Compare(This,range,pRetVal);
}
...
static __WIDL_INLINE HRESULT ITextRangeProvider2_FindAttribute(ITextRangeProvider2* This,TEXTATTRIBUTEID attributeId,VARIANT val,BOOL backward,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindAttribute(This,attributeId,val,backward,pRetVal);
}
static __WIDL_INLINE HRESULT ITextRangeProvider2_FindText(ITextRangeProvider2* This,BSTR text,BOOL backward,BOOL ignoreCase,ITextRangeProvider **pRetVal) {
    return This->lpVtbl->FindText(This,text,backward,ignoreCase,pRetVal);
}
...
static __WIDL_INLINE HRESULT ITextRangeProvider2_ScrollIntoView(ITextRangeProvider2* This,BOOL alignToTop) {
    return This->lpVtbl->ScrollIntoView(This,alignToTop);
}
...
/*** IUIAutomationPatternInstance methods ***/
static __WIDL_INLINE HRESULT IUIAutomationPatternInstance_GetProperty(IUIAutomationPatternInstance* This,UINT index,BOOL cached,enum UIAutomationType type,void *pPtr) {
