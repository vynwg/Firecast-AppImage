/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d3d11sdklayers.idl - Do not edit ***/
...
/*** ID3D11SwitchToRef methods ***/
static __WIDL_INLINE BOOL ID3D11SwitchToRef_SetUseRef(ID3D11SwitchToRef* This,BOOL useref) {
    return This->lpVtbl->SetUseRef(This,useref);
}
static __WIDL_INLINE BOOL ID3D11SwitchToRef_GetUseRef(ID3D11SwitchToRef* This) {
...
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnCategory(This,Category,bEnable);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnSeverity(This,Severity,bEnable);
}
static __WIDL_INLINE HRESULT ID3D11InfoQueue_SetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID,BOOL bEnable) {
    return This->lpVtbl->SetBreakOnID(This,ID,bEnable);
}
static __WIDL_INLINE BOOL ID3D11InfoQueue_GetBreakOnCategory(ID3D11InfoQueue* This,D3D11_MESSAGE_CATEGORY Category) {
    return This->lpVtbl->GetBreakOnCategory(This,Category);
}
static __WIDL_INLINE BOOL ID3D11InfoQueue_GetBreakOnSeverity(ID3D11InfoQueue* This,D3D11_MESSAGE_SEVERITY Severity) {
    return This->lpVtbl->GetBreakOnSeverity(This,Severity);
}
static __WIDL_INLINE BOOL ID3D11InfoQueue_GetBreakOnID(ID3D11InfoQueue* This,D3D11_MESSAGE_ID ID) {
    return This->lpVtbl->GetBreakOnID(This,ID);
}
static __WIDL_INLINE void ID3D11InfoQueue_SetMuteDebugOutput(ID3D11InfoQueue* This,BOOL bMute) {
    This->lpVtbl->SetMuteDebugOutput(This,bMute);
}
static __WIDL_INLINE BOOL ID3D11InfoQueue_GetMuteDebugOutput(ID3D11InfoQueue* This) {
