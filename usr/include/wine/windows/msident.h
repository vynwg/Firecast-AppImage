/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/msident.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUserIdentity_QueryInterface(IUserIdentity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUserIdentity_AddRef(IUserIdentity* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUserIdentity_Release(IUserIdentity* This) {
    return This->lpVtbl->Release(This);
}
/*** IUserIdentity methods ***/
static __WIDL_INLINE HRESULT IUserIdentity_GetCookie(IUserIdentity* This,GUID *puidCookie) {
    return This->lpVtbl->GetCookie(This,puidCookie);
}
static __WIDL_INLINE HRESULT IUserIdentity_GetName(IUserIdentity* This,WCHAR *pszName,ULONG ulBuffSize) {
    return This->lpVtbl->GetName(This,pszName,ulBuffSize);
}
static __WIDL_INLINE HRESULT IUserIdentity_OpenIdentityRegKey(IUserIdentity* This,DWORD dwDesiredAccess,HKEY *phKey) {
    return This->lpVtbl->OpenIdentityRegKey(This,dwDesiredAccess,phKey);
}
static __WIDL_INLINE HRESULT IUserIdentity_GetIdentityFolder(IUserIdentity* This,DWORD dwFlags,WCHAR *pszPath,ULONG ulBuffSize) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IEnumUserIdentity_QueryInterface(IEnumUserIdentity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IEnumUserIdentity_AddRef(IEnumUserIdentity* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IEnumUserIdentity_Release(IEnumUserIdentity* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumUserIdentity methods ***/
static __WIDL_INLINE HRESULT IEnumUserIdentity_Next(IEnumUserIdentity* This,ULONG celt,IUnknown **rgelt,ULONG *pceltFetched) {
    return This->lpVtbl->Next(This,celt,rgelt,pceltFetched);
}
static __WIDL_INLINE HRESULT IEnumUserIdentity_Skip(IEnumUserIdentity* This,ULONG celt) {
    return This->lpVtbl->Skip(This,celt);
}
static __WIDL_INLINE HRESULT IEnumUserIdentity_Reset(IEnumUserIdentity* This) {
    return This->lpVtbl->Reset(This);
}
static __WIDL_INLINE HRESULT IEnumUserIdentity_Clone(IEnumUserIdentity* This,IEnumUserIdentity **ppenum) {
    return This->lpVtbl->Clone(This,ppenum);
}
static __WIDL_INLINE HRESULT IEnumUserIdentity_GetCount(IEnumUserIdentity* This,ULONG *pnCount) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IUserIdentityManager_QueryInterface(IUserIdentityManager* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IUserIdentityManager_AddRef(IUserIdentityManager* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IUserIdentityManager_Release(IUserIdentityManager* This) {
    return This->lpVtbl->Release(This);
}
/*** IUserIdentityManager methods ***/
static __WIDL_INLINE HRESULT IUserIdentityManager_EnumIdentities(IUserIdentityManager* This,IEnumUserIdentity **ppEnumUser) {
    return This->lpVtbl->EnumIdentities(This,ppEnumUser);
}
static __WIDL_INLINE HRESULT IUserIdentityManager_ManageIdentities(IUserIdentityManager* This,HWND hwndParent,DWORD dwFlags) {
    return This->lpVtbl->ManageIdentities(This,hwndParent,dwFlags);
}
static __WIDL_INLINE HRESULT IUserIdentityManager_Logon(IUserIdentityManager* This,HWND hwndParent,DWORD dwFlags,IUserIdentity **ppIdentity) {
    return This->lpVtbl->Logon(This,hwndParent,dwFlags,ppIdentity);
}
static __WIDL_INLINE HRESULT IUserIdentityManager_Logoff(IUserIdentityManager* This,HWND hwndParent) {
    return This->lpVtbl->Logoff(This,hwndParent);
}
static __WIDL_INLINE HRESULT IUserIdentityManager_GetIdentityByCookie(IUserIdentityManager* This,GUID *uidCookie,IUserIdentity **ppIdentity) {
