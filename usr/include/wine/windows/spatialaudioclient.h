/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/spatialaudioclient.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT ISpatialAudioObjectBase_IsActive(ISpatialAudioObjectBase* This,BOOL *active) {
...
static __WIDL_INLINE HRESULT ISpatialAudioObject_IsActive(ISpatialAudioObject* This,BOOL *active) {
    return This->lpVtbl->IsActive(This,active);
}
