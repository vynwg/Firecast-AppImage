/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/mfd3d12.idl - Do not edit ***/
...
/*** IMFD3D12SynchronizationObjectCommands methods ***/
static __WIDL_INLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReady(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *producer_queue) {
    return This->lpVtbl->EnqueueResourceReady(This,producer_queue);
}
static __WIDL_INLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReadyWait(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
    return This->lpVtbl->EnqueueResourceReadyWait(This,consumer_queue);
}
static __WIDL_INLINE HRESULT IMFD3D12SynchronizationObjectCommands_SignalEventOnResourceReady(IMFD3D12SynchronizationObjectCommands* This,HANDLE event) {
    return This->lpVtbl->SignalEventOnResourceReady(This,event);
}
static __WIDL_INLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceRelease(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
