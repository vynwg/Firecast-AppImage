/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/dxgi1_6.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IDXGIOutput6_TakeOwnership(IDXGIOutput6* This,IUnknown *device,BOOL exclusive) {
...
/*** IDXGIOutput2 methods ***/
static __WIDL_INLINE BOOL IDXGIOutput6_SupportsOverlays(IDXGIOutput6* This) {
...
static __WIDL_INLINE BOOL IDXGIFactory6_IsCurrent(IDXGIFactory6* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static __WIDL_INLINE BOOL IDXGIFactory6_IsWindowedStereoEnabled(IDXGIFactory6* This) {
...
static __WIDL_INLINE BOOL IDXGIFactory7_IsCurrent(IDXGIFactory7* This) {
    return This->lpVtbl->IsCurrent(This);
}
/*** IDXGIFactory2 methods ***/
static __WIDL_INLINE BOOL IDXGIFactory7_IsWindowedStereoEnabled(IDXGIFactory7* This) {
    return This->lpVtbl->IsWindowedStereoEnabled(This);
}
