/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/docobjectservice.idl - Do not edit ***/
...
/*** IDocObjectService methods ***/
static __WIDL_INLINE HRESULT IDocObjectService_FireBeforeNavigate2(IDocObjectService* This,IDispatch *pDispatch,LPCWSTR lpszUrl,DWORD dwFlags,LPCWSTR lpszFrameName,BYTE *pPostData,DWORD cbPostData,LPCWSTR lpszHeaders,BOOL fPlayNavSound,BOOL *pfCancel) {
...
static __WIDL_INLINE HRESULT IDocObjectService_IsErrorUrl(IDocObjectService* This,LPCWSTR lpszUrl,BOOL *pfIsError) {
