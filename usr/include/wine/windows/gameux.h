/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/gameux.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IGameExplorer_QueryInterface(IGameExplorer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IGameExplorer_AddRef(IGameExplorer* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IGameExplorer_Release(IGameExplorer* This) {
    return This->lpVtbl->Release(This);
}
/*** IGameExplorer methods ***/
static __WIDL_INLINE HRESULT IGameExplorer_AddGame(IGameExplorer* This,BSTR sGDFBinaryPath,BSTR sInstallDirectory,GAME_INSTALL_SCOPE installScope,GUID *pguidInstanceID) {
    return This->lpVtbl->AddGame(This,sGDFBinaryPath,sInstallDirectory,installScope,pguidInstanceID);
}
static __WIDL_INLINE HRESULT IGameExplorer_RemoveGame(IGameExplorer* This,GUID instanceID) {
    return This->lpVtbl->RemoveGame(This,instanceID);
}
static __WIDL_INLINE HRESULT IGameExplorer_UpdateGame(IGameExplorer* This,GUID instanceID) {
    return This->lpVtbl->UpdateGame(This,instanceID);
}
static __WIDL_INLINE HRESULT IGameExplorer_VerifyAccess(IGameExplorer* This,BSTR sGDFBinaryPath,BOOL *pHasAccess) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IGameStatistics_QueryInterface(IGameStatistics* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IGameStatistics_AddRef(IGameStatistics* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IGameStatistics_Release(IGameStatistics* This) {
    return This->lpVtbl->Release(This);
}
/*** IGameStatistics methods ***/
static __WIDL_INLINE HRESULT IGameStatistics_GetMaxCategoryLength(IGameStatistics* This,UINT *cch) {
    return This->lpVtbl->GetMaxCategoryLength(This,cch);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetMaxNameLength(IGameStatistics* This,UINT *cch) {
    return This->lpVtbl->GetMaxNameLength(This,cch);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetMaxValueLength(IGameStatistics* This,UINT *cch) {
    return This->lpVtbl->GetMaxValueLength(This,cch);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetMaxCategories(IGameStatistics* This,WORD *pMax) {
    return This->lpVtbl->GetMaxCategories(This,pMax);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetMaxStatsPerCategory(IGameStatistics* This,WORD *pMax) {
    return This->lpVtbl->GetMaxStatsPerCategory(This,pMax);
}
static __WIDL_INLINE HRESULT IGameStatistics_SetCategoryTitle(IGameStatistics* This,WORD categoryIndex,LPCWSTR title) {
    return This->lpVtbl->SetCategoryTitle(This,categoryIndex,title);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetCategoryTitle(IGameStatistics* This,WORD categoryIndex,LPWSTR *pTitle) {
    return This->lpVtbl->GetCategoryTitle(This,categoryIndex,pTitle);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetStatistic(IGameStatistics* This,WORD categoryIndex,WORD statIndex,LPWSTR *pName,LPWSTR *pValue) {
    return This->lpVtbl->GetStatistic(This,categoryIndex,statIndex,pName,pValue);
}
static __WIDL_INLINE HRESULT IGameStatistics_SetStatistic(IGameStatistics* This,WORD categoryIndex,WORD statIndex,LPCWSTR name,LPCWSTR value) {
    return This->lpVtbl->SetStatistic(This,categoryIndex,statIndex,name,value);
}
static __WIDL_INLINE HRESULT IGameStatistics_Save(IGameStatistics* This,BOOL trackChanges) {
    return This->lpVtbl->Save(This,trackChanges);
}
static __WIDL_INLINE HRESULT IGameStatistics_SetLastPlayedCategory(IGameStatistics* This,UINT categoryIndex) {
    return This->lpVtbl->SetLastPlayedCategory(This,categoryIndex);
}
static __WIDL_INLINE HRESULT IGameStatistics_GetLastPlayedCategory(IGameStatistics* This,UINT *pCategoryIndex) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IGameStatisticsMgr_QueryInterface(IGameStatisticsMgr* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IGameStatisticsMgr_AddRef(IGameStatisticsMgr* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IGameStatisticsMgr_Release(IGameStatisticsMgr* This) {
    return This->lpVtbl->Release(This);
}
/*** IGameStatisticsMgr methods ***/
static __WIDL_INLINE HRESULT IGameStatisticsMgr_GetGameStatistics(IGameStatisticsMgr* This,LPCWSTR GDFBinaryPath,GAMESTATS_OPEN_TYPE openType,GAMESTATS_OPEN_RESULT *pOpenResult,IGameStatistics **ppiStats) {
    return This->lpVtbl->GetGameStatistics(This,GDFBinaryPath,openType,pOpenResult,ppiStats);
}
static __WIDL_INLINE HRESULT IGameStatisticsMgr_RemoveGameStatistics(IGameStatisticsMgr* This,LPCWSTR GDFBinaryPath) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IGameExplorer2_QueryInterface(IGameExplorer2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IGameExplorer2_AddRef(IGameExplorer2* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IGameExplorer2_Release(IGameExplorer2* This) {
    return This->lpVtbl->Release(This);
}
/*** IGameExplorer2 methods ***/
static __WIDL_INLINE HRESULT IGameExplorer2_InstallGame(IGameExplorer2* This,LPCWSTR binaryGDFPath,LPCWSTR installDirectory,GAME_INSTALL_SCOPE installScope) {
    return This->lpVtbl->InstallGame(This,binaryGDFPath,installDirectory,installScope);
}
static __WIDL_INLINE HRESULT IGameExplorer2_UninstallGame(IGameExplorer2* This,LPCWSTR binaryGDFPath) {
    return This->lpVtbl->UninstallGame(This,binaryGDFPath);
}
static __WIDL_INLINE HRESULT IGameExplorer2_CheckAccess(IGameExplorer2* This,LPCWSTR binaryGDFPath,BOOL *pHasAccess) {
