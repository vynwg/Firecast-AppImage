/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/wmprealestate.idl - Do not edit ***/
...
/*** IWMPRenderConfig methods ***/
static __WIDL_INLINE HRESULT IWMPRenderConfig_put_inProcOnly(IWMPRenderConfig* This,BOOL fInProc) {
    return This->lpVtbl->put_inProcOnly(This,fInProc);
}
static __WIDL_INLINE HRESULT IWMPRenderConfig_get_inProcOnly(IWMPRenderConfig* This,BOOL *pfInProc) {
