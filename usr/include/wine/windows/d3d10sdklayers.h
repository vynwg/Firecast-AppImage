/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d3d10sdklayers.idl - Do not edit ***/
...
/*** ID3D10SwitchToRef methods ***/
static __WIDL_INLINE BOOL ID3D10SwitchToRef_SetUseRef(ID3D10SwitchToRef* This,BOOL useref) {
    return This->lpVtbl->SetUseRef(This,useref);
}
static __WIDL_INLINE BOOL ID3D10SwitchToRef_GetUseRef(ID3D10SwitchToRef* This) {
...
static __WIDL_INLINE HRESULT ID3D10InfoQueue_SetBreakOnCategory(ID3D10InfoQueue* This,D3D10_MESSAGE_CATEGORY category,BOOL enable) {
    return This->lpVtbl->SetBreakOnCategory(This,category,enable);
}
static __WIDL_INLINE HRESULT ID3D10InfoQueue_SetBreakOnSeverity(ID3D10InfoQueue* This,D3D10_MESSAGE_SEVERITY severity,BOOL enable) {
    return This->lpVtbl->SetBreakOnSeverity(This,severity,enable);
}
static __WIDL_INLINE HRESULT ID3D10InfoQueue_SetBreakOnID(ID3D10InfoQueue* This,D3D10_MESSAGE_ID id,BOOL enable) {
    return This->lpVtbl->SetBreakOnID(This,id,enable);
}
static __WIDL_INLINE BOOL ID3D10InfoQueue_GetBreakOnCategory(ID3D10InfoQueue* This,D3D10_MESSAGE_CATEGORY category) {
    return This->lpVtbl->GetBreakOnCategory(This,category);
}
static __WIDL_INLINE BOOL ID3D10InfoQueue_GetBreakOnSeverity(ID3D10InfoQueue* This,D3D10_MESSAGE_SEVERITY severity) {
    return This->lpVtbl->GetBreakOnSeverity(This,severity);
}
static __WIDL_INLINE BOOL ID3D10InfoQueue_GetBreakOnID(ID3D10InfoQueue* This,D3D10_MESSAGE_ID id) {
    return This->lpVtbl->GetBreakOnID(This,id);
}
static __WIDL_INLINE void ID3D10InfoQueue_SetMuteDebugOutput(ID3D10InfoQueue* This,BOOL mute) {
    This->lpVtbl->SetMuteDebugOutput(This,mute);
}
static __WIDL_INLINE BOOL ID3D10InfoQueue_GetMuteDebugOutput(ID3D10InfoQueue* This) {
