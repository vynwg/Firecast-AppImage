/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d3d10.idl - Do not edit ***/
...
static __WIDL_INLINE void ID3D10Device_SetPredication(ID3D10Device* This,ID3D10Predicate *pPredicate,BOOL PredicateValue) {
...
static __WIDL_INLINE void ID3D10Device_GetPredication(ID3D10Device* This,ID3D10Predicate **ppPredicate,BOOL *pPredicateValue) {
...
static __WIDL_INLINE BOOL ID3D10Multithread_SetMultithreadProtected(ID3D10Multithread* This,BOOL bMTProtect) {
    return This->lpVtbl->SetMultithreadProtected(This,bMTProtect);
}
static __WIDL_INLINE BOOL ID3D10Multithread_GetMultithreadProtected(ID3D10Multithread* This) {
