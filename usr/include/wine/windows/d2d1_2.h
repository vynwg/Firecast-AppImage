/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/d2d1_2.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT ID2D1Factory2_RegisterEffectFromStream(ID2D1Factory2* This,REFCLSID effect_id,IStream *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromStream(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static __WIDL_INLINE HRESULT ID2D1Factory2_RegisterEffectFromString(ID2D1Factory2* This,REFCLSID effect_id,const WCHAR *property_xml,const struct D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT ID2D1CommandSink1_QueryInterface(ID2D1CommandSink1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG ID2D1CommandSink1_AddRef(ID2D1CommandSink1* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG ID2D1CommandSink1_Release(ID2D1CommandSink1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1CommandSink methods ***/
static __WIDL_INLINE HRESULT ID2D1CommandSink1_BeginDraw(ID2D1CommandSink1* This) {
    return This->lpVtbl->BeginDraw(This);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_EndDraw(ID2D1CommandSink1* This) {
    return This->lpVtbl->EndDraw(This);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetAntialiasMode(ID2D1CommandSink1* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetTags(ID2D1CommandSink1* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    return This->lpVtbl->SetTags(This,tag1,tag2);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetTextAntialiasMode(ID2D1CommandSink1* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetTextRenderingParams(ID2D1CommandSink1* This,IDWriteRenderingParams *text_rendering_params) {
    return This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetTransform(ID2D1CommandSink1* This,const D2D1_MATRIX_3X2_F *transform) {
    return This->lpVtbl->SetTransform(This,transform);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetPrimitiveBlend(ID2D1CommandSink1* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    return This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetUnitMode(ID2D1CommandSink1* This,D2D1_UNIT_MODE unit_mode) {
    return This->lpVtbl->SetUnitMode(This,unit_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_Clear(ID2D1CommandSink1* This,const D2D1_COLOR_F *color) {
    return This->lpVtbl->Clear(This,color);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawGlyphRun(ID2D1CommandSink1* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    return This->lpVtbl->DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawLine(ID2D1CommandSink1* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawGeometry(ID2D1CommandSink1* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawRectangle(ID2D1CommandSink1* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    return This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawBitmap(ID2D1CommandSink1* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    return This->lpVtbl->DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawImage(ID2D1CommandSink1* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    return This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_DrawGdiMetafile(ID2D1CommandSink1* This,ID2D1GdiMetafile *metafile,const D2D1_POINT_2F *target_offset) {
    return This->lpVtbl->DrawGdiMetafile(This,metafile,target_offset);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_FillMesh(ID2D1CommandSink1* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    return This->lpVtbl->FillMesh(This,mesh,brush);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_FillOpacityMask(ID2D1CommandSink1* This,ID2D1Bitmap *bitmap,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    return This->lpVtbl->FillOpacityMask(This,bitmap,brush,dst_rect,src_rect);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_FillGeometry(ID2D1CommandSink1* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    return This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_FillRectangle(ID2D1CommandSink1* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    return This->lpVtbl->FillRectangle(This,rect,brush);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_PushAxisAlignedClip(ID2D1CommandSink1* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    return This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_PushLayer(ID2D1CommandSink1* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    return This->lpVtbl->PushLayer(This,layer_parameters,layer);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_PopAxisAlignedClip(ID2D1CommandSink1* This) {
    return This->lpVtbl->PopAxisAlignedClip(This);
}
static __WIDL_INLINE HRESULT ID2D1CommandSink1_PopLayer(ID2D1CommandSink1* This) {
    return This->lpVtbl->PopLayer(This);
}
/*** ID2D1CommandSink1 methods ***/
static __WIDL_INLINE HRESULT ID2D1CommandSink1_SetPrimitiveBlend1(ID2D1CommandSink1* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
