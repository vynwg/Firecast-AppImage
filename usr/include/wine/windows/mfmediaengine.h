/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/mfmediaengine.idl - Do not edit ***/
...
static __WIDL_INLINE BOOL IMFMediaTimeRange_ContainsTime(IMFMediaTimeRange* This,double time) {
...
static __WIDL_INLINE BOOL IMFMediaEngine_IsSeeking(IMFMediaEngine* This) {
...
static __WIDL_INLINE BOOL IMFMediaEngine_IsPaused(IMFMediaEngine* This) {
...
static __WIDL_INLINE BOOL IMFMediaEngine_IsEnded(IMFMediaEngine* This) {
    return This->lpVtbl->IsEnded(This);
}
static __WIDL_INLINE BOOL IMFMediaEngine_GetAutoPlay(IMFMediaEngine* This) {
    return This->lpVtbl->GetAutoPlay(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngine_SetAutoPlay(IMFMediaEngine* This,BOOL autoplay) {
    return This->lpVtbl->SetAutoPlay(This,autoplay);
}
static __WIDL_INLINE BOOL IMFMediaEngine_GetLoop(IMFMediaEngine* This) {
    return This->lpVtbl->GetLoop(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngine_SetLoop(IMFMediaEngine* This,BOOL loop) {
...
static __WIDL_INLINE BOOL IMFMediaEngine_GetMuted(IMFMediaEngine* This) {
    return This->lpVtbl->GetMuted(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngine_SetMuted(IMFMediaEngine* This,BOOL muted) {
...
static __WIDL_INLINE BOOL IMFMediaEngine_HasVideo(IMFMediaEngine* This) {
    return This->lpVtbl->HasVideo(This);
}
static __WIDL_INLINE BOOL IMFMediaEngine_HasAudio(IMFMediaEngine* This) {
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_IsSeeking(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsSeeking(This);
}
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_IsPaused(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsPaused(This);
}
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_IsEnded(IMFMediaEngineEx* This) {
    return This->lpVtbl->IsEnded(This);
}
static __WIDL_INLINE BOOL IMFMediaEngineEx_GetAutoPlay(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetAutoPlay(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_SetAutoPlay(IMFMediaEngineEx* This,BOOL autoplay) {
    return This->lpVtbl->SetAutoPlay(This,autoplay);
}
static __WIDL_INLINE BOOL IMFMediaEngineEx_GetLoop(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetLoop(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_SetLoop(IMFMediaEngineEx* This,BOOL loop) {
    return This->lpVtbl->SetLoop(This,loop);
}
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_GetMuted(IMFMediaEngineEx* This) {
    return This->lpVtbl->GetMuted(This);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_SetMuted(IMFMediaEngineEx* This,BOOL muted) {
    return This->lpVtbl->SetMuted(This,muted);
}
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_HasVideo(IMFMediaEngineEx* This) {
    return This->lpVtbl->HasVideo(This);
}
static __WIDL_INLINE BOOL IMFMediaEngineEx_HasAudio(IMFMediaEngineEx* This) {
    return This->lpVtbl->HasAudio(This);
}
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_IsPlaybackRateSupported(IMFMediaEngineEx* This,double rate) {
    return This->lpVtbl->IsPlaybackRateSupported(This,rate);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_FrameStep(IMFMediaEngineEx* This,BOOL forward) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_GetStreamSelection(IMFMediaEngineEx* This,DWORD stream_index,BOOL *enabled) {
    return This->lpVtbl->GetStreamSelection(This,stream_index,enabled);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_SetStreamSelection(IMFMediaEngineEx* This,DWORD stream_index,BOOL enabled) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_IsProtected(IMFMediaEngineEx* This,BOOL *protected) {
    return This->lpVtbl->IsProtected(This,protected);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_InsertVideoEffect(IMFMediaEngineEx* This,IUnknown *effect,BOOL is_optional) {
    return This->lpVtbl->InsertVideoEffect(This,effect,is_optional);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_InsertAudioEffect(IMFMediaEngineEx* This,IUnknown *effect,BOOL is_optional) {
...
static __WIDL_INLINE BOOL IMFMediaEngineEx_IsStereo3D(IMFMediaEngineEx* This) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_EnableWindowlessSwapchainMode(IMFMediaEngineEx* This,BOOL enable) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_EnableHorizontalMirrorMode(IMFMediaEngineEx* This,BOOL enable) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_GetRealTimeMode(IMFMediaEngineEx* This,BOOL *enabled) {
    return This->lpVtbl->GetRealTimeMode(This,enabled);
}
static __WIDL_INLINE HRESULT IMFMediaEngineEx_SetRealTimeMode(IMFMediaEngineEx* This,BOOL enable) {
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_EnableTimeUpdateTimer(IMFMediaEngineEx* This,BOOL enable) {
...
/*** IMFMediaEngineExtension methods ***/
static __WIDL_INLINE HRESULT IMFMediaEngineExtension_CanPlayType(IMFMediaEngineExtension* This,BOOL audio_only,BSTR mime_type,MF_MEDIA_ENGINE_CANPLAY *answer) {
