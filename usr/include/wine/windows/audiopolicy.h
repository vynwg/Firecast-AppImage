/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/audiopolicy.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IAudioSessionEvents_OnSimpleVolumeChanged(IAudioSessionEvents* This,float NewVolume,BOOL NewMute,LPCGUID EventContext) {
...
static __WIDL_INLINE HRESULT IAudioSessionControl_SetDisplayName(IAudioSessionControl* This,LPCWSTR DisplayName,LPCGUID EventContext) {
...
static __WIDL_INLINE HRESULT IAudioSessionControl2_SetDisplayName(IAudioSessionControl2* This,LPCWSTR DisplayName,LPCGUID EventContext) {
    return This->lpVtbl->SetDisplayName(This,DisplayName,EventContext);
}
...
static __WIDL_INLINE HRESULT IAudioSessionControl2_SetDuckingPreferences(IAudioSessionControl2* This,BOOL optOut) {
