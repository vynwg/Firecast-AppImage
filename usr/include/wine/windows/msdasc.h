/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/msdasc.idl - Do not edit ***/
...
/*** IDataInitialize methods ***/
static __WIDL_INLINE HRESULT IDataInitialize_GetDataSource(IDataInitialize* This,IUnknown *pUnkOuter,DWORD dwClsCtx,LPCOLESTR pwszInitializationString,REFIID riid,IUnknown **ppDataSource) {
...
static __WIDL_INLINE HRESULT IDataInitialize_LoadStringFromStorage(IDataInitialize* This,LPCOLESTR pwszFileName,LPOLESTR *ppwszInitializationString) {
    return This->lpVtbl->LoadStringFromStorage(This,pwszFileName,ppwszInitializationString);
}
static __WIDL_INLINE HRESULT IDataInitialize_WriteStringToStorage(IDataInitialize* This,LPCOLESTR pwszFileName,LPCOLESTR pwszInitializationString,DWORD dwCreationDisposition) {
