/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/mimeinfo.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IMimeInfo_QueryInterface(IMimeInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IMimeInfo_AddRef(IMimeInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IMimeInfo_Release(IMimeInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMimeInfo methods ***/
static __WIDL_INLINE HRESULT IMimeInfo_GetMimeCLSIDMapping(IMimeInfo* This,UINT *pcTypes,LPCSTR **ppszTypes,CLSID **ppclsID) {
