/*** Autogenerated by WIDL 9.2 from ../wine-9.2/include/inseng.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IInstallEngineCallback_OnEngineProblem(IInstallEngineCallback* This,DWORD problem,LPDWORD action) {
